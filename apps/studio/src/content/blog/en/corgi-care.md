...
faqs:
  ...
  - question: "How should I manage Welsh Corgi shedding?"
    answer: "Corgis have a heavy-shedding double coat. Brush daily with a slicker and undercoat rake to remove trapped dead fur, promote air circulation, and prevent skin infections."
---

Welsh Corgis are loved for their short legs and fluffy backsides. As former herding dogs, they are smart, active, and bold. However, their long backs and short legs place heavy stress on their spine and joints. Obesity increases the risk of spinal disc issues, making daily care essential. Today, PetSelf explores Corgi body language and introduces a 3-step routine to protect their spine and joints.
...
<div class="my-8 p-6 rounded-[2rem] border border-emerald-500/20 bg-emerald-500/5 dark:border-emerald-500/20 dark:bg-emerald-950/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-emerald-700/80 dark:text-emerald-400/80 m-0 mt-1.5 leading-relaxed">
      This content is based on <strong>Official Guide of the Pembroke Welsh Corgi Club of America & AKC Health Guidelines</strong>.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-500/10 shadow-sm">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Since their long backs make them prone to spinal issues, secure all floor mats under sofas and do a gentle 2-minute thigh and joint stretch in the morning.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/60 dark:border-slate-800/60 pb-4 mb-4 cursor-pointer" open>
    ...
    <p class="mt-3 text-sm text-slate-650 dark:text-slate-300 leading-relaxed pl-1">
      Because of their long backs and short legs, landing from high surfaces puts over three times the normal impact on their spine and knees, directly causing spinal disc issues. Installing pet stairs is essential.
    </p>
  </details>

  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none" role="button" aria-expanded="false">
      <span>How should I manage Welsh Corgi shedding?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400">▼</span>
    </summary>
    <p class="mt-3 text-sm text-slate-650 dark:text-slate-300 leading-relaxed pl-1">
      Corgis have a heavy-shedding double coat. Brush daily with a slicker and undercoat rake to remove trapped dead fur, promote air circulation, and prevent skin infections.
    </p>
  </details>
</div>
