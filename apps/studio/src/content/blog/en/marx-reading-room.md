...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      This analysis regarding marx-reading-room is based on <strong>카를 마르크스 역사적 평전 및 자서전 기록 고증 & 인지신경과학(Cognitive Neuroscience) 연구</strong>.
    </p>
  </div>
</div>
...
연합 피질은 시각, 언어, 추리적 정보를 유기적으로 종합하여 새로운 개념적 지도(지식 체계)를 구축하는 중추입니다. 마르크스처럼 방대한 도서에서 관련 수치를 찾아 직접 손으로 옮겨 적고 이를 비판적으로 분석하는 과정은 연합 피질 내부의 시냅스 연결망을 극대화합니다. 이 과정에서 뇌는 단편적인 정보에 함몰되지 않고 복잡한 현상의 본질적인 인과적 뼈대를 발견하는 거시적 시스템 사고 역량을 획득하게 됩니다.
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">아날로그 딥 리딩 환경 구축</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    도서관의 조용한 구역이나 스마트폰 수신이 제한된 방을 선택합니다. 모든 알림을 끄고 전자기기를 시야 밖으로 완전히 치워 뇌에 들어오는 불필요한 노이즈를 사전에 방어합니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">수기 초록 및 발췌 노트 작성</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    준비한 책이나 연구 자료를 읽으며, 뇌가 깊이 소화해야 할 핵심 사실, 통계 데이터, 혹은 주요 문구를 아날로그 공책에 펜으로 정성을 들여 한 줄 한 줄 직접 손으로 옮겨 적습니다.
  </p>
</div>
