...
steps:
  - name: "Step 1: Blocking Self-Censorship & Rapidly Generating a Rough Draft"
    text: "Disregard perfection and error correction, rapidly outputting the primary skeleton, workflow, or logic of your document, code, or design from start to finish within a time limit."
  - name: "Step 2: Micro-Chunk Segmentation & Iterative Keyboard-Style Refining"
    text: "Divide the draft into narrow units (paragraphs, sentences, or code modules). Re-read and test each unit repeatedly like playing a phrase on keys, pruning awkward phrasing or noise."
  - name: "Step 3: Holistic Structural Integration & Final Polish"
    text: "Connect the fine-tuned segments into a single cohesive whole, verifying that individual micro-details blend seamlessly into the overarching structure for final delivery."
faqs:
  - question: "Doesn't obsessive, perfectionist iteration hinder progress and cause missed deadlines?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Step 1: Blocking Self-Censorship & Rapidly Generating a Rough Draft</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Step 2: Micro-Chunk Segmentation & Iterative Keyboard-Style Refining</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Step 3: Holistic Structural Integration & Final Polish</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Doesn't obsessive, perfectionist iteration hinder progress and cause missed deadlines?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">At what point during iterative refinement should one stop modifying and finalize the work?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
