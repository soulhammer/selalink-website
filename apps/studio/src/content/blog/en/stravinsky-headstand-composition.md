...
오늘 포스트에서는 스트라빈스키의 물구나무 창의법의 작동 원리를 파헤치고, 현대인들이 지적 피로와 슬럼프를 겪을 때 이를 현대적으로 안전하게 실천하여 단 1분 만에 뇌를 리프레시하고 창조적 돌파구를 찾아내는 3단계 실천 방안을 제시합니다.
...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      This analysis regarding stravinsky-headstand-composition is based on <strong>Stravinsky Headstand Composition 역사적 평전 및 자서전 기록 고증 & 인지신경과학(Cognitive Neuroscience) 연구</strong>.
    </p>
  </div>
</div>
