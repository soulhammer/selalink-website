...
title: "Common Musk Turtle Sunbathing Stretch and 3-Step Water Filtration Routine"
...
faqs:
  ...
  - question: "Is it normal for my turtle's shell plates to peel off?"
    answer: "Yes. As turtles grow, they shed old scutes, which peel off as thin, translucent pieces. However, if you see white slimy discharge or a soft smelly shell, it is a sign of shell rot and needs vet care."
---

The compact Common Musk Turtle is ideal for beginners. Although they spend most of their time in water, regular dry basking under a UV lamp is essential for shell disinfection and vitamin D synthesis. Poor water quality and lack of dry basking can lead to painful shell rot. Today on PetSelf, we explain their basking languages, warning signs, and a 3-step tank management routine for crystal-clear water.
...
<div class="my-8 p-6 rounded-[2rem] border border-emerald-500/20 bg-emerald-500/5 dark:border-emerald-500/20 dark:bg-emerald-950/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-emerald-700/80 dark:text-emerald-400/80 m-0 mt-1.5 leading-relaxed">
      This content is based on <strong>World Chelonian Association Basking Guidelines and Aquatic Turtle Protocol</strong>.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-500/10 shadow-sm">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    ...
    <strong>• Response:</strong> Avoid sudden movements in front of the tank and step back until they feel safe enough to peek out.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-500/10 shadow-sm">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Check the water thermometer (keep at 25-28°C) and feed age-appropriate commercial turtle pellets.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/60 dark:border-slate-800/60 pb-4 mb-4 cursor-pointer" open>
    ...
    <p class="mt-3 text-sm text-slate-650 dark:text-slate-300 leading-relaxed pl-1">
      No. Chlorine in tap water irritates a turtle's sensitive eyes and skin, causing dryness or swelling. Use water aged for 24 hours or dechlorinating drops.
    </p>
  </details>
  ...
  <details class="group cursor-pointer">
    ...
    <p class="mt-3 text-sm text-slate-650 dark:text-slate-300 leading-relaxed pl-1">
      Yes. As turtles grow, they shed old scutes, which peel off as thin, translucent pieces. However, if you see white slimy discharge or a soft smelly shell, it is a sign of shell rot and needs vet care.
    </p>
  </details>
</div>
