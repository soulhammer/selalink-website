...
title: "紫陆潮蟹（紫陆西氏外壳）换壳与深度打洞蜕皮3阶段日常护理指南"
description: "针对热门宠物甲壳类紫陆潮蟹 (Coenobita clypeatus)。了解供其蜕皮的深度垫料打洞（Burrowing）设置，以及维持腮呼吸温湿度的3阶段日常护理流程。"
pubDate: "2026-07-07"
...
app: "petself"
formatVersion: 4
authority: "世界甲壳类协会 (HCA) 及异宠兽医临床指南"
steps:
  - name: "紫陆潮蟹的行为表达：缩壳隐蔽 (Shell Hiding) 与触角抖动"
    text: "当感到威胁或惊吓时，寄居蟹会迅速缩入螺壳并用大螯封住壳口（“缩壳隐蔽 (Shell Hiding)”）。而在感到安全并产生好奇心时，它们会探出身体并快速抖动触角（“触角探嗅”）来收集周围的气味分子。"
  - name: "紫陆潮蟹 / 灰白陆潮蟹 (Purple Pincher / Coenobita clypeatus) 的肢体语言与行为信号"
    text: "* 缩入螺壳并用大螯挡住入口 (Shell Hiding): 针对外界威胁或陌生环境的防御反应，表明其处于不安与应激状态。 (切勿强行将其拉出螺壳，调暗灯光，让其自然适应后自行爬出。)

* 探出身体并快速晃动触角 (Antenna Waving): 表明处于放松和好奇状态，正在积极探索环境或寻找食物与水源。 (提供新鲜食物，并确保淡水水盆与海水水盆水质清洁。)"
  - name: "紫陆潮蟹 / 灰白陆潮蟹 (Purple Pincher / Coenobita clypeatus) 定制化 3 步家庭护理流程"
    text: "* STEP 1. 早上：环境温湿度 (24-28℃, 75-85%) 检查与淡海水更换: 维持75-85%湿度以保障其腮部呼吸。更换去氯淡水与人工海水水盆。

* STEP 2. 下午：垫料湿度检查与备用螺壳补充: 检查沙层深度（至少蟹体3倍深）与湿度（能捏成沙堡状），提供多种口径的无毒天然螺壳。

* STEP 3. 晚上：钙质与蛋白质夜间喂食及潜沙个体保护: 夜间投喂钙粉、蛋白质及新鲜蔬果。对于已打洞潜沙蜕皮的个体，切勿挖沙扰动。"
faqs:
  - question: "寄居蟹潜入沙下好几个星期不出来，是死了吗？"
    answer: "不是。寄居蟹需要深入湿润的沙层下进行蜕皮 (Molting)。蜕皮期间它们的新身体极其脆弱，切勿挖沙扰动，否则可能导致致命应激。蜕皮完成后它们会自动爬出。"
  - question: "饲养陆寄居蟹为什么一定要提供海水？"
...
## 1. 紫陆潮蟹的行为表达：缩壳隐蔽 (Shell Hiding) 与触角抖动
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">紫陆潮蟹的行为表达：缩壳隐蔽 (Shell Hiding) 与触角抖动</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    当感到威胁或惊吓时，寄居蟹会迅速缩入螺壳并用大螯封住壳口（“缩壳隐蔽 (Shell Hiding)”）。而在感到安全并产生好奇心时，它们会探出身体并快速抖动触角（“触角探嗅”）来收集周围的气味分子。
  </p>
</div>

---

## 2. 紫陆潮蟹 / 灰白陆潮蟹 (Purple Pincher / Coenobita clypeatus) 的肢体语言与行为信号
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">缩入螺壳并用大螯挡住入口 (Shell Hiding)</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">探出身体并快速晃动触角 (Antenna Waving)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      <div class="flex items-center gap-2 mb-2">
...
## 3. 紫陆潮蟹 / 灰白陆潮蟹 (Purple Pincher / Coenobita clypeatus) 定制化 3 步家庭护理流程

<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    <span class="px-3.5 py-1.5 text-xs font-black tracking-wider bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300 rounded-full border border-indigo-500/30 shadow-xs">ROUTINE 1</span>
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">早上：环境温湿度 (24-28℃, 75-85%) 检查与淡海水更换</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    维持75-85%湿度以保障其腮部呼吸。更换去氯淡水与人工海水水盆。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">下午：垫料湿度检查与备用螺壳补充</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    检查沙层深度（至少蟹体3倍深）与湿度（能捏成沙堡状），提供多种口径的无毒天然螺壳。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">晚上：钙质与蛋白质夜间喂食及潜沙个体保护</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    夜间投喂钙粉、蛋白质及新鲜蔬果。对于已打洞潜沙蜕皮的个体，切勿挖沙扰动。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">寄居蟹潜入沙下好几个星期不出来，是死了吗？</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      不是。寄居蟹需要深入湿润的沙层下进行蜕皮 (Molting)。蜕皮期间它们的新身体极其脆弱，切勿挖沙扰动，否则可能导致致命应激。蜕皮完成后它们会自动爬出。
    </p>
  </details>

  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">饲养陆寄居蟹为什么一定要提供海水？</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      陆寄居蟹需要通过海水来调节体内渗透压和维持螺壳内的水份平衡。必须使用水族专用的海水素（如 Instant Ocean）配制海水，绝不能使用食用盐，且须同时提供淡水和海水两个水盆。
    </p>
  </details>
</div>
