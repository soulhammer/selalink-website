...
app: "buildself"
formatVersion: 4
authority: "大谷翔平历史评传及自传记录考证与认知神经科学（Cognitive Neuroscience）研究"
steps:
  - name: "设计曼陀罗目标计划表"
    text: "在纸张或电子平板上绘制3x3网格，在中央写下最终目标，并在周围8个格子中梳理具体策略，将可立即执行的行动计划可视化。"
  - name: "打造遮光与控温的睡眠环境"
    text: "为了保障高质量的深度睡眠，安装遮光窗帘彻底降低光线，并将室内温度调节至凉爽舒适的18摄氏度左右。"
  - name: "结合午睡补足总睡眠时间"
...
现代棒球界的传奇、美国职棒大联盟（MLB）历史上首位达成“50本垒打-50盗垒”壮举的“二刀流”天才大谷翔平（Shohei Ohtani，1994年出生）。他之所以能屡获全票MVP并率队勇夺世界棒球经典赛（WBC）冠军、保持压倒性的竞技状态，秘诀在于他从高中时期便坚持的两项严谨 routine。

第一是他在花卷东高等学校一年级时制定的“曼陀罗计划表（Mandalart）”，将人生目标与执行策略解构为81格的网格图；第二是每日保持10小时以上恢复性睡眠的习惯，即便在客场比赛时也随身携带定制枕头。许多现代人为了成功牺牲睡眠并将计划停留在脑海中，而大谷翔平则通过曼陀罗计划表减轻前额叶的认知过载，并利用深度睡眠每日完美重置身体与脑神经网络。

本篇文章将解析大谷翔平的曼陀罗目标架构与睡眠习惯背后的神经科学机制，并为现代人提供三步实践指南，帮助大家在日常生活中确立清晰目标并达成最佳恢复状态。
...
<div class="my-8 p-6 md:p-7 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-r from-indigo-500/10 via-indigo-500/5 to-transparent dark:border-indigo-500/30 dark:from-indigo-950/30 dark:to-slate-900/40 flex items-start sm:items-center gap-4 shadow-xs backdrop-blur-md">
  ...
  <div class="flex-1 min-w-0">
    ...
    <p class="text-xs md:text-sm text-indigo-800/90 dark:text-indigo-300/90 font-medium m-0 mt-1.5 leading-relaxed break-words">
      本内容基于 大谷翔平历史评传及自传记录考证与认知神经科学（Cognitive Neuroscience）研究。
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">设计曼陀罗目标计划表</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    在纸张或电子平板上绘制3x3网格，在中央写下最终目标，并在周围8个格子中梳理具体策略，将可立即执行的行动计划可视化。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">打造遮光与控温的睡眠环境</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    为了保障高质量的深度睡眠，安装遮光窗帘彻底降低光线，并将室内温度调节至凉爽舒适的18摄氏度左右。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">结合午睡补足总睡眠时间</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">10小时睡眠对于忙碌的现代人来说不太现实，可以减少吗？</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      10小时是针对高强度运动的顶尖职业运动员的标准，对于日常工作生活，保证7 ~ 8小时的高质量睡眠就足够了。核心不在于拘泥于时间长短，而在于通过规律的作息与卧室环境调节，最大化深度睡眠（慢波睡眠）的比例。
    </p>
  </details>
</div>
