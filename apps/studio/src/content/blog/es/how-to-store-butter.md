...
steps:
  - name: "Mantener el papel de aluminio original 📦"
    text: "El envoltorio original de aluminio es excelente para bloquear la luz y el aire, evitando que se oxide."
  - name: "Doble sellado para evitar olores 📰"
    text: "Coloque la mantequilla en una bolsa hermética o recipiente para que no absorba olores de otros alimentos."
  - name: "Cortar en porciones y congelar ❄️"
    text: "Para conservar a largo plazo, corte la mantequilla en cubos, envuélvalos en papel encerado y congélelos."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Mantener el papel de aluminio original 📦</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    El envoltorio original de aluminio es excelente para bloquear la luz y el aire, evitando que se oxide.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Doble sellado para evitar olores 📰</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Coloque la mantequilla en una bolsa hermética o recipiente para que no absorba olores de otros alimentos.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Cortar en porciones y congelar ❄️</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Para conservar a largo plazo, corte la mantequilla en cubos, envuélvalos en papel encerado y congélelos.
  </p>
</div>
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-rose-500 bg-rose-500/5 flex items-start gap-4">
  ...
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">No guarde en la puerta del refrigerador ⚠️</strong>
    <p class="text-slate-700 dark:text-slate-300 text-sm m-0 leading-relaxed">
      La puerta es la zona más cálida y tiene fluctuaciones constantes de temperatura, lo que daña la estructura de la mantequilla.
    </p>
  </div>
</div>
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-amber-500 bg-amber-500/5 flex items-start gap-4">
  <span class="text-xl">⚠️</span>
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">Evite la contaminación cruzada al cortar 🧈</strong>
    <p class="text-slate-700 dark:text-slate-300 text-sm m-0 leading-relaxed">
      Usar un cuchillo húmedo o sucio introduce humedad y bacterias, acelerando su descomposición.
    </p>
  </div>
</div>
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
