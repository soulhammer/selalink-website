...
app: "buildself"
formatVersion: 4
authority: "Investigación biográfica histórica sobre Sócrates e investigación en Neurociencia Cognitiva"
steps:
  - name: "Desconectarse del Estímulo Digital"
    text: "Ponga su teléfono en el bolsillo o active el modo avión. Caminar mientras mira una pantalla impide que el cerebro entre en el estado cognitivo necesario para el pensamiento profundo."
  - name: "Caminar en la Naturaleza durante 15 Minutos a Ritmo Constante"
    text: "Encuentre una calle tranquila o un parque y camine durante 15 minutos a un ritmo constante. Concéntrese en sus pasos, la naturaleza que lo rodea y la respiración para calmar el cerebro."
  - name: "Hacer una Pregunta Principal y Debatir Internamente"
    text: "Establezca una pregunta o desafío principal para el día. Mientras camina, pregúntese '¿Por qué?' y respóndase, repitiendo el ciclo para obtener perspicacias inesperadas."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Desconectarse del Estímulo Digital</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Caminar en la Naturaleza durante 15 Minutos a Ritmo Constante</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Hacer una Pregunta Principal y Debatir Internamente</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">¿Caminar en una cinta de correr interior produce el mismo efecto?</span>
