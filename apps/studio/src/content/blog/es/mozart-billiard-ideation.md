...
app: "buildself"
formatVersion: 4
authority: "Investigación de biografías históricas y registros autobiográficos de Mozart y estudios de neurociencia cognitiva"
steps:
  - name: "Detener el trabajo de inmediato cuando los pensamientos se congelen"
    text: "Cuando haya reflexionado durante más de una hora sin avances, empuje inmediatamente su teclado o bolígrafo y levántese."
  - name: "Sumergirse en un juego físico visoespacial durante 10 minutos"
    text: "Concéntrese por completo en un juego físico como el billar, dardos o acertijos de trayectoria espacial durante 10 minutos, dejando descansar la corteza prefrontal."
  - name: "Regresar al escritorio y capturar las revelaciones emergentes"
    text: "Vuelva a sentarse y examine su proyecto. A menudo, un nuevo camino o avance creativo sintetizado durante el descanso emergerá de forma natural a la conciencia."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Detener el trabajo de inmediato cuando los pensamientos se congelen</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Sumergirse en un juego físico visoespacial durante 10 minutos</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Regresar al escritorio y capturar las revelaciones emergentes</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
