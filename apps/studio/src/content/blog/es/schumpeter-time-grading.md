...
app: "buildself"
formatVersion: 4
authority: "Investigación basada en biografías históricas y registros autobiográficos de Schumpeter y Neurociencia Cognitiva"
steps:
  - name: "Paso 1: Revisión del tiempo libre de emociones"
    text: "Cada noche al terminar sus labores, revise los registros del teléfono o calendario para listar objetivamente lo que hizo en intervalos de 30 minutos."
  - name: "Paso 2: Autocalificación basada en rúbricas claras"
    text: "Asigne una calificación (A–F) de acuerdo con sus criterios (ej. Trabajo profundo 4 hrs = A, 2 hrs = B, más de 3 distracciones = D)."
  - name: "Paso 3: Identificación de causa y regla N.º 1 para mañana"
    text: "Identifique la causa raíz de la nota de hoy (ej. 1 hora perdida en redes sociales) y diseñe una mejora, como aislar el teléfono 1 hora mañana."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Paso 1: Revisión del tiempo libre de emociones</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Paso 2: Autocalificación basada en rúbricas claras</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Paso 3: Identificación de causa y regla N.º 1 para mañana</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">¿Qué debo hacer si me descubro siendo demasiado indulgente o haciendo trampa con las notas?</span>
