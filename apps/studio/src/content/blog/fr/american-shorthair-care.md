...
steps:
  - name: "Langage corporel de l'American Shorthair : surcharge cardiaque et halètement"
    text: "Un chat ne halète pas comme un chien. Si un American Shorthair a la 'bouche ouverte pour respirer' ou montre une 'fatigue soudaine' pendant le jeu, c'est le signe d'un problème cardiaque majeur. Réagir vite peut lui sauver la vie."
  - name: "American Shorthair's Body Language & Signals"
    text: "* Respiration Bouche Ouverte: Le chat respire la bouche ouverte, langue sortie, traduisant un manque d'oxygène critique ou une détresse cardiaque. (Limitez le stress et conduisez le chat en urgence chez le vétérinaire pour une mise sous oxygène.)

* Fatigue Rapide après l'effort: Le chat s'arrête de jouer et se couche sur le flanc en quelques minutes par manque de débit cardiaque. (Stoppez le jeu et faites réaliser un examen cardiaque (échographie) chez votre vétérinaire pour dépister la CMH.)"
  - name: "Customized 3-Step Home Care Routine"
    text: "* STEP 1. Matin : Rationnement précis de la nourriture pour éviter la prise de poids: Évitez le libre-service. Divisez sa portion de croquettes quotidienne selon ses besoins caloriques réels pour protéger son cœur.

* STEP 2. Après-midi : Jeu interactif de 15 minutes pour brûler les graisses: Jouez avec lui au moins deux fois par jour pendant 15 minutes (canne à pêche, plumeau) pour stimuler son activité physique.

* STEP 3. Soir : Brossage hebdomadaire pour éliminer le sous-poil: Bien qu'à poil court, sa fourrure est dense. Brossez-le une à deux fois par semaine pour prévenir les vomissements de boules de poils."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-500/10 shadow-sm">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langage corporel de l'American Shorthair : surcharge cardiaque et halètement</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-500/10 shadow-sm">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    ...
    <strong>• Reponse:</strong> Limitez le stress et conduisez le chat en urgence chez le vétérinaire pour une mise sous oxygène.
  </p>
</div>
