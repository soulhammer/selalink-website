...
steps:
  ...
  - name: "들풀이나 야생화의 생김새를 자세히 들여다보며 관찰하기"
    text: "가던 길을 멈추고 땅 밑의 이끼나 나뭇잎, 야생초의 결을 면밀히 관찰합니다. 잎맥의 갈래나 꽃잎의 수 등 자연의 세밀한 기하학에 뇌의 초점을 모읍니다."
...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      L'analyse concernant rousseau-botany-walk est basée sur <strong>Rousseau Botany Walk 역사적 평전 및 자서전 기록 고증 & 인지신경과학(Cognitive Neuroscience) 연구</strong>.
    </p>
  </div>
</div>
