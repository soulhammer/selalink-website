...
steps:
  - name: "데일리 절차 실습 기술 선정"
    text: "타자 연습, 외국어 소리 내어 읽기, 개발 코드 클론 코딩 등 물리적으로 손가락과 감각 세포를 직접 정교하게 사용하는 대상을 하루 1가지 선정합니다."
  - name: "이론 배경 20% 퀵 드로잉"
    text: "실무 조작을 행하기 직전, 5~10분간 수행할 원리나 기본 가이드를 빠르게 눈으로 훑어보아 인지 기초 틀을 점화합니다."
  - name: "80% 에너지의 피지컬 실습 수행"
    text: "남은 20~30분간 고도로 기민하게 손가락과 눈을 조율하며 소뇌 회로에 지식을 각인시킵니다. 실수하더라도 멈추지 않고 손의 작동 흐름(Flow)을 지속합니다."
faqs:
...
오늘 포스트에서는 피터 대제가 실천했던 피지컬 기술 실습 루틴의 과학적 작동 원리와 현대인들이 복잡한 도구 조작이나 기술 습득 시 망각하지 않는 지식 체계를 구축하기 위해 이를 어떻게 응용할 수 있는지 알아봅니다.
...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      L'analyse concernant peter-early-labor est basée sur <strong>Peter Early Labor 역사적 평전 및 자서전 기록 고증 & 인지신경과학(Cognitive Neuroscience) 연구</strong>.
    </p>
  </div>
</div>
