...
faqs:
  ...
  - question: "モルモットは1匹だけで飼うことができますか？"
    answer: "モルモットは本来、群れで暮らす社会性の高い動物です。1匹だけで飼うと深い孤独からうつ状態になるリスクがあるため、相性の良い2匹以上での飼育が強く推奨されます。"
---

体全体にある「ロゼット（つむじ）」と呼ばれる個性的な巻き毛と、愛らしい鳴き声で人気のアビシニアンギニアピッグ（イングリッシュと並ぶ代表的なモルモットの品種）。モルモットは体内でビタミンCを合成できないため、食事から毎日摂取しなければ壊血病や関節の腫れ、免疫低下を引き起こします。また、呼吸器が非常にデリケートなため、ケージ内の衛生管理と牧草の粉塵対策が欠かせません。今回は、モルモット特有の感情表現を解説し、ビタミンC補給と呼吸器を守る3ステップのホームケアルーチンをご紹介します。
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-500/10 shadow-sm">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    ...
    <strong>• 対処法:</strong> 跳ねた拍子にケージの角にぶつかって怪我をしないよう、安全なレイアウトにしておきます。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-500/10 shadow-sm">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    水に溶かすと分解されやすいため、サプリメントやビタミンCを豊富に含む生野菜を直接与えます。新鮮なチモシーを補充します。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer">
    ...
    <p class="mt-3 text-sm text-slate-650 dark:text-slate-300 leading-relaxed pl-1">
      モルモットは本来、群れで暮らす社会性の高い動物です。1匹だけで飼うと深い孤独からうつ状態になるリスクがあるため、相性の良い2匹以上での飼育が強く推奨されます。
    </p>
  </details>
</div>
