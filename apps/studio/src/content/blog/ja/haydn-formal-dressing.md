...
steps:
  - name: "ステップ1：パジャマの脱却および整った「作業服」の着用"
    text: "在宅勤務や自主作業を開始する前、パジャマやだぼだぼのホームウェアを完全に脱ぎ、きちんとした外出着や作業服に着替えます。服を変える動作自体が脳に「業務モード転換」の信号を伝達します。"
  - name: "ステップ2：視覚的認知ノイズ遮断のための作業台の整理"
    text: "作業台の上に散らかった不必要な物品、飲み残しのカップ、無関係な書類を綺麗に片付けます。視覚的ノイズを除去することで、前頭葉の注意力消耗を遮断します。"
  - name: "ステップ3：没頭象徴アンカリングスイッチ（アクセサリー/時計）の稼働"
    text: "作業開始時にのみ時計をはめたり特定の指輪を嵌めるなど、専用のアクセサリーを着用します。特定の視覚・触覚刺激を「高度な生産的活動」と条件づける脳の訓練を完成させます。"
faqs:
  - question: "ハイドンは本当に一人で家にいる時も常にスーツを着て作曲したのですか？"
    answer: "はい、その通りです。ハイドンはだらしのない服装からは散漫な音楽的アイデアしか生まれないと信じていました。彼は一人でいる書斎でもスーツとカツラ、指輪を整えて着用し、自分の脳を精緻な没頭状態へとセットアップしました。"
  - question: "在宅勤務の際、必ずスーツのように息苦しい服でなければなりませんか？気楽な外出着でも効果がありますか？"
    answer: "息苦しいタキシードやスーツである必要はありません。核心は「寝る時や休む時に着る服」と「仕事をする時に着る服」を物理的にはっきりと分離することです。清潔なシャツやスラックスのような外出着に着替えるだけでも、脳の着衣認知（Enclothed Cognition）効果は十分に稼働します。"
---

「芸術の創造は、ただ秩序と 粘り強さに支えられてこそ完成する。だらしない服装からは、だらしない音楽的アイデアしか生まれない。」 🚶‍♂️

古典派音楽の様式を確立し、「交響曲の父」、「弦楽四重奏の父」と呼ばれる西洋音楽史の巨匠フランツ・ヨーゼフ・ハイドン（Franz Joseph Haydn、1732–1809）。エステルハージ（Esterházy）伯爵家の宮廷楽長として30年近く在職し、生涯で104曲の交響曲と68曲の弦楽四重奏曲という驚異的な名曲を発表した彼には、生涯守り続けたユニークな執筆習慣がありました。

それは、作曲を開始する前に常に綺麗に髭を剃り、完璧なスーツを整えて着用した後に粉を振ったカツラを被り、指に国王から賜った大切なお気に入りの指輪を嵌めることでした。ハイドンの伝記作家ディス（Albert Christoph Dies）が記録したように、彼は一人でいる自分の書斎で作業をする時でさえ、乱れた身なりでピアノやオーケストラ楽譜の前に座ることはありませんでした。ハイドンは、だらしない服装からは決して秩序正しく精緻なオーケストレーションが生まれないと固く信じていたのです。服を整える物理的な儀式は、彼にとって単なる衛生面の問題ではなく、脳を即座に高度な精密没頭状態へと誘導する最も強力な認知的スイッチでした。私たちの服装が脳に及ぼす「着衣認知」科学の秘密を解き明かします。
...
<div class="my-8 p-6 md:p-7 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-r from-indigo-500/10 via-indigo-500/5 to-transparent dark:border-indigo-500/30 dark:from-indigo-950/30 dark:to-slate-900/40 flex items-start sm:items-center gap-4 shadow-xs backdrop-blur-md">
  ...
  <div class="flex-1 min-w-0">
    ...
    <p class="text-xs md:text-sm text-indigo-800/90 dark:text-indigo-300/90 font-medium m-0 mt-1.5 leading-relaxed break-words">
      本コンテンツは、ヨーゼフ・ハイドン伝記（Dies & Griesinger）およびエステルハージ（Esterházy）アーカイブ史料考証＆認知神経科学（Cognitive Neuroscience）研究に基づいています。
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">ステップ1：パジャマの脱却および整った「作業服」の着用</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    在宅勤務や自主作業を開始する前、パジャマやだぼだぼのホームウェアを完全に脱ぎ、きちんとした外出着や作業服に着替えます。服を変える動作自体が脳に「業務モード転換」の信号を伝達します。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">ステップ2：視覚的認知ノイズ遮断のための作業台の整理</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    作業台の上に散らかった不必要な物品、飲み残しのカップ、無関係な書類を綺麗に片付けます。視覚的ノイズを除去することで、前頭葉の注意力消耗を遮断します。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">ステップ3：没頭象徴アンカリングスイッチ（アクセサリー/時計）の稼働</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    作業開始時にのみ時計をはめたり特定の指輪を嵌めるなど、専用のアクセサリーを着用します。特定の視覚・触覚刺激を「高度な生産的活動」と条件づける脳の訓練を完成させます。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">ハイドンは本当に一人で家にいる時も常にスーツを着て作曲したのですか？</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">在宅勤務の際、必ずスーツのように息苦しい服でなければなりませんか？気楽な外出着でも効果がありますか？</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      息苦しいタキシードやスーツである必要はありません。核心は「寝る時や休む時に着る服」と「仕事をする時に着る服」を物理的にはっきりと分離することです。清潔なシャツやスラックスのような外出着に着替えるだけでも、脳の着衣認知（Enclothed Cognition）効果は十分に稼働します。
    </p>
  </details>
</div>
