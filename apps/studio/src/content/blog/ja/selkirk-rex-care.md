...
steps:
  - name: "セルカークレックスのボディランゲージ：頻繁な吐き戻し（毛玉サイン）と耳を振る動作"
    text: "セルカークレックスが「えづくような動作や頻繁な毛玉吐き」を見せる場合、抜け落ちたカール毛を グルーミングで大量に飲み込んでしまったサインです。一方「頭を頻繁に振ったり耳を足で掻く」行動は、耳道内の皮脂や耳垢の過剰蓄積を示しています。"
  - name: "セルカークレックス (Selkirk Rex)のボディランゲージと行動サイン"
    text: "* 頻繁な毛玉のえづきと吐き戻し (Hairball Distress): 抜け落ちたカール毛が皮膚付近に留まり、グルーミング時に胃へ入って大きな毛玉（ヘアボール）を形成している状態です。 (目の粗いコームで優しく抜け毛を取り除き、ヘアボールケア用サプリメントを与えます。)

* 頭を振る・耳を掻く (Ear Shaking & Scratching): 耳道の巻き毛により通気性が悪くなり、皮脂や耳垢が溜まって刺激や外耳炎を引き起こしているサインです。 (低刺激のイヤーローションで優しく耳垢を拭き取り、赤みや臭いが強い場合は獣医師の診察を受けてください。)"
...
## 1. セルカークレックスのボディランゲージ：頻繁な吐き戻し（毛玉サイン）と耳を振る動作
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">セルカークレックスのボディランゲージ：頻繁な吐き戻し（毛玉サイン）と耳を振る動作</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    セルカークレックスが「えづくような動作や頻繁な毛玉吐き」を見せる場合、抜け落ちたカール毛を グルーミングで大量に飲み込んでしまったサインです。一方「頭を頻繁に振ったり耳を足で掻く」行動は、耳道内の皮脂や耳垢の過剰蓄積を示しています。
  </p>
</div>

---

## 2. セルカークレックス (Selkirk Rex)のボディランゲージと行動サイン
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">頻繁な毛玉のえづきと吐き戻し (Hairball Distress)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        抜け落ちたカール毛が皮膚付近に留まり、グルーミング時に胃へ入って大きな毛玉（ヘアボール）を形成している状態です。
      </p>
    </div>
    <div class="p-4 md:p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-950/30">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        目の粗いコームで優しく抜け毛を取り除き、ヘアボールケア用サプリメントを与えます。
      </p>
    </div>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">頭を振る・耳を掻く (Ear Shaking & Scratching)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      <div class="flex items-center gap-2 mb-2">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        耳道の巻き毛により通気性が悪くなり、皮脂や耳垢が溜まって刺激や外耳炎を引き起こしているサインです。
      </p>
    </div>
    <div class="p-4 md:p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-950/30">
      <div class="flex items-center gap-2 mb-2">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        低刺激のイヤーローションで優しく耳垢を拭き取り、赤みや臭いが強い場合は獣医師の診察を受けてください。
      </p>
    </div>
  </div>
</div>
...
## 3. セルカークレックス (Selkirk Rex)のための3ステップホームケアルーティン

<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    <span class="px-3.5 py-1.5 text-xs font-black tracking-wider bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300 rounded-full border border-indigo-500/30 shadow-xs">ROUTINE 1</span>
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">朝：耳のチェックと目の粗いコームでの毛並み整え</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    耳内の状態を確認し、カールの美しさを損なわないよう目の粗いコームや手ぐしで抜け毛を優しく取り除きます。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">夜：ヒゲ周りのケアとヘアボールケアペーストの給与</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    カールしたヒゲや顔周りの汚れを拭き取り、胃の中の毛玉排出を助けるペースト状サプリメントを与えます。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">セルカークレックスは毎日ブラッシングすべきですか？</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      目の細かいブラシで毎日ブラッシングすると美しいカールが伸びてしまいます。週2〜3回、目の粗いコーム（ピンブラシ）を使って抜け毛だけを優しく取り除くのが理想的です。
    </p>
  </details>
