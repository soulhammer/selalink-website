...
app: "petself"
formatVersion: 4
authority: "Cat Fanciers' Association (CFA) & Protocolos Felinos da WSAVA"
steps:
  - name: "Linguagem corporal do Scottish Straight: Postura de Buda (Sprawled Sitting) e orelhas de avião (Airplane Ears)"
    text: "Os gatos Scottish Straight comunicam relaxamento e incômodo através de posturas marcantes. Deitar-se de costas com a barriga para cima ou sentar-se sobre o quadril 'Postura de Buda (Sprawled Sitting)' indica total confiança e segurança no lar. Por outro lado, achatar as orelhas para os lados balançando a cauda 'Orelhas de avião (Airplane Ears)' é um sinal de irritação, estresse ou dor articular."
  - name: "Linguagem corporal e sinais de comportamento do Scottish Straight (Scottish Straight)"
    text: "* Deitado de costas ou sentado sobre o quadril (Sprawled Sitting / Buddha Position): Sinal de máxima confiança e relaxamento, indicando que o gato se sente completamente seguro. (Fale com ele em tom suave sem assustá-lo, piscando os olhos lentamente para reforçar o afeto.)

* Orelhas achatadas para os lados e cauda balançando (Airplane Ears & Tail Flicking): Reação a ruídos, manuseio incômodo, estresse ambiental ou dor nas articulações. (Afaste as fontes de estresse e ofereça um esconderijo calmo para ele descansar.)"
...
<div class="my-8 p-6 md:p-7 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-r from-emerald-500/10 via-emerald-500/5 to-transparent dark:border-emerald-500/30 dark:from-emerald-950/30 dark:to-slate-900/40 flex items-start sm:items-center gap-4 shadow-xs backdrop-blur-md">
  ...
  <div class="flex-1 min-w-0">
    ...
    <p class="text-xs md:text-sm text-emerald-800/90 dark:text-emerald-300/90 font-medium m-0 mt-1.5 leading-relaxed break-words">
      Este conteúdo baseia-se em Cat Fanciers' Association (CFA) & Protocolos Felinos da WSAVA.
    </p>
  </div>
</div>
...
## 1. Linguagem corporal do Scottish Straight: Postura de Buda (Sprawled Sitting) e orelhas de avião (Airplane Ears)
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">Linguagem corporal do Scottish Straight: Postura de Buda (Sprawled Sitting) e orelhas de avião (Airplane Ears)</h4>
  </div>
...
## 2. Linguagem corporal e sinais de comportamento do Scottish Straight (Scottish Straight)
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">Deitado de costas ou sentado sobre o quadril (Sprawled Sitting / Buddha Position)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        Sinal de máxima confiança e relaxamento, indicando que o gato se sente completamente seguro.
      </p>
    </div>
    <div class="p-4 md:p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-950/30">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        Fale com ele em tom suave sem assustá-lo, piscando os olhos lentamente para reforçar o afeto.
      </p>
    </div>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">Orelhas achatadas para os lados e cauda balançando (Airplane Ears & Tail Flicking)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      <div class="flex items-center gap-2 mb-2">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        Reação a ruídos, manuseio incômodo, estresse ambiental ou dor nas articulações.
      </p>
    </div>
    <div class="p-4 md:p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-950/30">
      <div class="flex items-center gap-2 mb-2">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        Afaste as fontes de estresse e ofereça um esconderijo calmo para ele descansar.
      </p>
    </div>
  </div>
</div>
...
## 3. Rotina diária de 3 passos para cuidados com Scottish Straight (Scottish Straight)

<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    <span class="px-3.5 py-1.5 text-xs font-black tracking-wider bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300 rounded-full border border-indigo-500/30 shadow-xs">ROUTINE 1</span>
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">Manhã: Controle de peso, ração rica em proteína medida & higiene dos olhos</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    Forneça ração rica em proteína com porções controladas contra a obesidade, limpando os cantos dos olhos com gaze.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">Noite: Brincadeira de baixo impacto no chão (15–20 min) & escovação da pelagem</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    Brinque com varinhas no chão para queimar calorias sem esforçar as articulações e escove o pelo denso.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Qual a diferença entre Scottish Fold e Straight, e o Straight tem doenças genéticas?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">O Scottish Straight engorda fácil, como controlar o peso dele?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      O temperamento calmo favorece o ganho de peso. Ofereça alimento medido rico em proteínas e baixo em carboidratos, e faça sessões diárias de 15 a 20 minutos de brincadeiras rasteiras para manter a massa muscular e proteger o coração.
    </p>
  </details>
</div>
