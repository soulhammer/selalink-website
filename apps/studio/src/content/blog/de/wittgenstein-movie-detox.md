...
title: "Überhitzte Gehirne abkühlen: Ludwig Wittgensteins Western-Film-Detox-Routine"
description: "Ludwig Wittgenstein schaute in der ersten Reihe des Kinos Westernfilme, um sein überhitztes Gehirn bei der Arbeit an der Sprachphilosophie zu entlasten. Beleuchtet, wie visuelle Immersion den präfrontalen Kortex entlastet."
pubDate: "2026-03-14"
...
app: "buildself"
formatVersion: 4
authority: "Historische Biografien und Dokumente zu Ludwig Wittgenstein sowie Kognitive Neurowissenschaften"
steps:
  - name: "Einrichten einer visuell einnehmenden Entspannungsumgebung"
    text: "Schalten Sie das Licht aus und setzen Sie sich vor einen großen Bildschirm, der Ihr Sichtfeld ausfüllt."
  - name: "Auswahl einfacher, analysefreier Medien"
    text: "Wählen Sie unkomplizierte Actionfilme, leichte Unterhaltungsfilme oder friedliche Naturdokumentationen."
  - name: "Stoppen der kognitiven Analyse und sofortiges Schlafen nach dem Film"
    text: "Bewerten Sie den Film nicht kritisch, sondern lassen Sie den Blick 30–60 Minuten über das Bild gleiten und gehen Sie danach direkt schlafen."
faqs:
...
## 1. Gehirnkreis-Reset und Inkubation durch erzwungene Aufmerksamkeitsumlenkung
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Einrichten einer visuell einnehmenden Entspannungsumgebung</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Auswahl einfacher, analysefreier Medien</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Stoppen der kognitiven Analyse und sofortiges Schlafen nach dem Film</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Hat das stundenlange Anschauen von Short-Videos oder Reels auf dem Smartphone einen ähnlichen Effekt?</span>
