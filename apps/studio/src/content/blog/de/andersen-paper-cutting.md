...
steps:
  - name: "Schritt 1: Bereitstellen eines Blattes Papier und einer Schere"
    text: "Legen Sie am Nachmittag oder nach Feierabend bei ausgeschalteten Smartphone-Benachrichtigungen ein Blatt normales Papier (z. B. Konzeptpapier oder einen Briefumschlag) und eine sichere Schere auf den Schreibtisch."
  - name: "Schritt 2: Regel-freies Falten und Schneiden"
    text: "Falten Sie das Papier 2- oder 4-mal in eine beliebige Form. Vor ohne Regeln oder Zielmusterentwürfe halten Sie die Schere und schneiden Sie das Papier frei zurecht, wohin Ihre Hand Sie führt."
  - name: "Schritt 3: Eintauchen in knusprige Geräusche und taktile Empfindungen"
    text: "Konzentrieren Sie während der 5 Minuten des Schneidens Ihre gesamte Aufmerksamkeit ausschließlich auf das knusprige Reibungsgeräusch der Schere auf dem Papier und den erfrischenden Rückstoß an Ihren Fingerspitzen, wenn das Papier abfällt."
faqs:
  - question: "Ist es in Ordnung, wenn ich kein künstlerisches Händchen habe und nicht gut schneiden kann?"
...
Das <strong>'Default Mode Network (DMN)'</strong>, das aktiv ist, wenn das Gehirn ruht, ohne eine bestimmte Aufgabe auszuführen, verstärkt bei modernen Menschen unnötiges Nachdenken (Overthinking) wie Reue über die Vergangenheit und Zukunftsängste. Laut Ergotherapie und neurowissenschaftlicher Forschung wärmt <strong>'feine Handarbeit'</strong> wie Scherenarbeiten oder Zeichnen, die die Fingerspitzen feinfühlig steuert, den motorischen Kortex des Gehirns auf und deaktiviert gleichzeitig sofort das überlastete DMN. Die einfache, symmetrische taktile Stimulation des Faltens und Schneidens von Papier direkt vor Ihren Augen stoppt das Nachdenken und schenkt dem Gehirn eine tiefe kognitive Pause.
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 1: Bereitstellen eines Blattes Papier und einer Schere</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 2: Regel-freies Falten und Schneiden</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 3: Eintauchen in knusprige Geräusche und taktile Empfindungen</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Ist es in Ordnung, wenn ich kein künstlerisches Händchen habe und nicht gut schneiden kann?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Stört der entstehende Papiermüll nach dem Schneiden die Entspannung beim Aufräumen?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
