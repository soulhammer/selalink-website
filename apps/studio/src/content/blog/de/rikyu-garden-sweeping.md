...
app: "buildself"
formatVersion: 4
authority: "Historische kritische Biografie und autobiografische Aufzeichnungen über Rikyus Gartenfegen sowie kognitive neurowissenschaftliche Forschung"
steps:
  - name: "Ziel-Reinigungsbereich und Werkzeuge festlegen"
    text: "Wählen Sie einen kleinen Bereich aus, der morgens gereinigt werden soll, und bereiten Sie manuelle Werkzeuge wie einen Besen oder ein Tuch vor. Blockieren Sie externe Ablenkungen gründlich und konzentrieren Sie sich voll und ganz darauf, ein klares Ausführungsziel im Frontallappen des Gehirns zu etablieren."
  - name: "Rhythmische wiederholte Handlung und sensorischer Fokus"
    text: "Führen Sie das Fegen oder Wischen in einem gleichmäßigen Rhythmus aus und verankern Sie das gesamte Bewusstsein nur auf dem Geräusch des Besens und dem taktilen Feedback der Bewegung."
  - name: "Absichtliche Wertschätzung des Freiraums und Abschluss der Routine"
    text: "Betrachten Sie nach Abschluss der 5-minütigen Aktivität ruhig den ordentlichen Bereich zusammen mit seinen subtilen natürlichen Unvollkommenheiten und genießen Sie die innere Stille."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Ziel-Reinigungsbereich und Werkzeuge festlegen</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Rhythmische wiederholte Handlung und sensorischer Fokus</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Absichtliche Wertschätzung des Freiraums und Abschluss der Routine</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Wie kann ich Reinigen als Meditation nutzen?</span>
