...
steps:
  - name: "Schritt 1: Vorbereitung verschiedener Aufgaben mit unterschiedlichen kognitiven Merkmalen"
    text: "Um verschiedene Gehirnermüdungsbereiche überkreuz zu nutzen, bereiten Sie stets 2 bis 3 Arten von Aufgaben mit sich nicht überschneidenden kognitiven Schaltkreisen nebeneinander vor, wie z. B. Schreibarbeiten, die hohe Ausdrücke erfordern, Budgetplanung, die intuitive Zahleneingabe erfordert, oder das Auswendiglernen von Fremdwörtern."
  - name: "Schritt 2: Proaktiver Kontextwechsel bei Erreichen der Konzentrationsgrenze"
    text: "Wenn Sie bei einer Aufgabe feststecken oder Langeweile verspüren, überlasten Sie das Gehirn nicht unnötig; wechseln Sie stattdessen die Aufgabe, als würden Sie sofort zur nächsten Schreibmaschine gehen. Schalten Sie den Bildschirm sofort auf einen bereits geöffneten Tab oder ein Dokument um, um die Vertiefung in die nächste Aufgabe umgehend zu starten."
  - name: "Schritt 3: Induzieren der Gehirnaktivierung durch neue regionale Reize"
    text: "Blockieren Sie die Ermüdung der vorherigen Arbeit kognitiv durch den Neuheits-Effekt der neu gewählten Aufgabe. Das Gehirn genießt einen ausreichenden Erholungseffekt und hält den Fokus reibungslos aufrecht, nicht nur durch das Stoppen der Arbeit, sondern einfach durch das 'Aktivieren eines anderen Bereichs'."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 1: Vorbereitung verschiedener Aufgaben mit unterschiedlichen kognitiven Merkmalen</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 2: Proaktiver Kontextwechsel bei Erreichen der Konzentrationsgrenze</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 3: Induzieren der Gehirnaktivierung durch neue regionale Reize</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Warum benutzte Isaac Asimov abwechselnd mehrere Schreibmaschinen?</span>
