...
app: "buildself"
formatVersion: 4
authority: "Historische Biografien und Schriften über Henri Poincaré & Kognitive Neurowissenschaften"
steps:
  - name: "Ein tägliches 'Fokus-Zeitlimit' festlegen"
    text: "8 Stunden lang ununterbrochen hochkonzentriert zu arbeiten, ist physiologisch unmöglich. Setzen Sie sich wie Poincaré feste Blöcke (z. B. zwei 2-Stunden-Blöcke) mit einem Timer und arbeiten Sie darin hochfokussiert."
  - name: "Bei mentaler Blockade sofort aufstehen"
    text: "Wenn Sie 15 Minuten lang bei einem Problem feststecken, verlassen Sie den Schreibtisch. Unterbrechen Sie den fokussierten Modus und aktivieren Sie den diffusen Modus durch einen 15–20-minütigen Spaziergang."
  - name: "Unterbewusste Eingebungen sofort festhalten"
    text: "Antworten, die das Unterbewusstsein in Ruhephasen liefert, verfliegen schnell. Nutzen Sie ein Notizbuch oder Sprachmemos, um kreative Geistesblitze sofort festzuhalten."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Ein tägliches 'Fokus-Zeitlimit' festlegen</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Bei mentaler Blockade sofort aufstehen</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Unterbewusste Eingebungen sofort festhalten</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Warum forschte Henri Poincaré nur 4 Stunden am Tag?</span>
