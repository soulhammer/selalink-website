...
app: "buildself"
formatVersion: 4
authority: "Historische Biografien, autobiografische Aufzeichnungen zu Schulz' Hamburger-Routine & kognitionswissenschaftliche (Cognitive Neuroscience) Forschung"
steps:
  - name: "Legen Sie unwichtige Lebenselemente im Voraus fest"
    text: "Bestimmen Sie eine feste Arbeitskleidung oder legen Sie einfache Mittagessen-Menüs für jeden Wochentag fest, um morgendliche Bedenkzeit zu vermeiden."
  - name: "Verankern Sie Arbeitszeit und Ort regelmäßig"
    text: "Gewöhnen Sie sich an, jeden Tag zur gleichen Zeit am selben Schreibtisch zu sitzen, damit das Gehirn ohne Willensaufwand sofort in den Arbeitsmodus schaltet."
  - name: "Setzen Sie geschonte kognitive Ressourcen für Deep Work ein"
    text: "Investieren Sie die durch das Einsparen alltäglicher Entscheidungen gewonnene Konzentration zuerst in die wichtigsten strategischen Planungs-, Entwicklungs- oder Schreibaufgaben."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Legen Sie unwichtige Lebenselemente im Voraus fest</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Verankern Sie Arbeitszeit und Ort regelmäßig</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Setzen Sie geschonte kognitive Ressourcen für Deep Work ein</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Ist es ungesund, jeden Tag das gleiche Mittagessen zu essen? Wie können wir Schulz' Gewohnheit modern anwenden?</span>
