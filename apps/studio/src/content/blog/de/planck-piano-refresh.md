...
app: "buildself"
formatVersion: 4
authority: "Historische Biografien und Schriften über Max Planck & Kognitive Neurowissenschaften"
steps:
  - name: "Ein Instrument für freie Improvisation bereitstellen"
    text: "Stellen Sie ein leicht zugängliches Klavier oder Keyboard in der Nähe Ihres Arbeitsbereichs auf."
  - name: "5 Minuten freies Tasten-Spielen ohne Noten"
    text: "Schließen Sie die Noten, schalten Sie logisches Denken aus und spielen Sie 5 Minuten lang frei nach Gefühl."
  - name: "Klangwahrnehmung und geistiger Reset"
    text: "Kompensieren Sie geistige Müdigkeit, indem Sie sich ganz auf Klangwellen und Resonanzen konzentrieren, um den Reset abzuschließen."
faqs:
  - question: "Wie beginnt man eine Klavierimprovisation ohne Noten?"
...
<div class="my-8 p-6 md:p-7 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-r from-indigo-500/10 via-indigo-500/5 to-transparent dark:border-indigo-500/30 dark:from-indigo-950/30 dark:to-slate-900/40 flex items-start sm:items-center gap-4 shadow-xs backdrop-blur-md">
  ...
  <div class="flex-1 min-w-0">
    ...
    <p class="text-xs md:text-sm text-indigo-800/90 dark:text-indigo-300/90 font-medium m-0 mt-1.5 leading-relaxed break-words">
      Dieser Inhalt basiert auf Historische Biografien und Schriften über Max Planck & Kognitive Neurowissenschaften.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Ein Instrument für freie Improvisation bereitstellen</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Stellen Sie ein leicht zugängliches Klavier oder Keyboard in der Nähe Ihres Arbeitsbereichs auf.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">5 Minuten freies Tasten-Spielen ohne Noten</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Schließen Sie die Noten, schalten Sie logisches Denken aus und spielen Sie 5 Minuten lang frei nach Gefühl.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Klangwahrnehmung und geistiger Reset</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Kompensieren Sie geistige Müdigkeit, indem Sie sich ganz auf Klangwellen und Resonanzen konzentrieren, um den Reset abzuschließen.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Wie beginnt man eine Klavierimprovisation ohne Noten?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Kann man einen kognitiven Reset auch mit anderen Instrumenten erreichen?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      Ja, Saiten- oder Tasteninstrumente wie Gitarre oder Ukulele, die feine Finger-Sensorik verlangen, bieten den gleichen Effekt zum Wechsel des Aufmerksamkeitsnetzwerks.
    </p>
  </details>
</div>
