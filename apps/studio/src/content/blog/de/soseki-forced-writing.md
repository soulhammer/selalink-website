...
app: "buildself"
formatVersion: 4
authority: "Historische Biografien, autobiografische Aufzeichnungen zu Sosekis erzwungenem Schreiben & kognitionswissenschaftliche (Cognitive Neuroscience) Forschung"
steps:
  - name: "Sichern Sie eine unbedingte morgendliche Schreibumgebung"
    text: "Legen Sie nach dem Aufstehen sofort das Smartphone weg und setzen Sie sich an den Schreibtisch. Blockieren Sie externe Ablenkungen vollständig, um dem präfrontalen Kortex ein klares Ziel vorzugeben."
  - name: "Erzwungenes Schreiben im Bewusstseinsstrom für 10 Minuten"
    text: "Schreiben Sie 10 Minuten lang ununterbrochen auf, was Ihnen durch den Kopf geht, ohne sich Gedanken über Rechtschreibung oder Inhalt zu machen."
  - name: "Beenden der Routine nach Erreichen des quantitativen Ziels"
    text: "Sobald Sie das festgelegte Ziel von 30 Minuten oder die Mindestwortanzahl erreicht haben, räumen Sie Ihren Platz auf und beenden die Sitzung mit einem Gefühl des Erfolgs."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Sichern Sie eine unbedingte morgendliche Schreibumgebung</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Erzwungenes Schreiben im Bewusstseinsstrom für 10 Minuten</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Beenden der Routine nach Erreichen des quantitativen Ziels</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Was soll ich tun, wenn mir gar nichts einfällt und ich mich nicht konzentrieren kann?</span>
