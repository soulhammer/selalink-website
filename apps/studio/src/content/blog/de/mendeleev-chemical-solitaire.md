...
app: "buildself"
formatVersion: 4
authority: "Historische Biografien & Aufzeichnungen zu Mendelejew & Kognitive Neurowissenschaften"
steps:
  - name: "Informationen in einzelne Karten aufteilen"
    text: "Zerlegen Sie komplexe Aufgaben oder Projektdaten, indem Sie jeweils ein einzelnes Schlüsselwort auf die Vorderseite von Karteikarten schreiben."
  - name: "Karten auf einem Tisch anordnen und verschieben"
    text: "Breiten Sie die Karten auf einem großen Tisch aus. Verschieben Sie sie mit den Fingern, um sie nach Ursache-Wirkung oder Kategorien zu ordnen."
  - name: "Das fertige Strukturlayout fotografieren und archivieren"
    text: "Sobald eine logische Anordnung entsteht, fotografieren Sie das Ergebnis mit dem Smartphone, um das physische Raster im Gedächtnis zu verankern."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Informationen in einzelne Karten aufteilen</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Karten auf einem Tisch anordnen und verschieben</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Das fertige Strukturlayout fotografieren und archivieren</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Können Mindmap-Software physische Zettel oder Karteikarten ersetzen?</span>
