...
app: "buildself"
formatVersion: 4
authority: "Historische Biografien und autobiografische Aufzeichnungen von Mutter Teresa & kognitive Neurowissenschaften"
steps:
  - name: "Schritt 1: Sichern Sie sich sofort nach dem Aufstehen einen ruhigen Meditationsraum"
    text: "Schalten Sie nach dem Aufwachen auf keinen Fall Ihren Smartphone-Bildschirm ein. Setzen Sie sich aufrecht auf ein Kissen an den ruhigsten Ort in Ihrer Wohnung, ohne Ihr Gehirn visuellen oder digitalen Reizen auszusetzen."
  - name: "Schritt 2: 15 Minuten vollkommen stille Atmung"
    text: "Schließen Sie ohne Musik oder weißes Rauschen leise die Augen und verharren Sie 15 Minuten lang in Stille. Richten Sie all Ihre Aufmerksamkeit nur auf die Empfindung der ein- und ausströmenden Luft."
  - name: "Schritt 3: Aktivieren Sie den beruhigenden Schild für tägliche Begegnungen"
    text: "Öffnen Sie nach der Stille die Augen. Erkennen Sie mit einem beruhigten präfrontalen Kortex Ihren inneren Schild, um Konflikte mit gelassener Vernunft zu bewältigen, dehnen Sie sich leicht und beginnen Sie den Tag."
faqs:
  - question: "Was soll ich tun, wenn während der Meditation ständig Aufgaben und Sorgen auftauchen?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 1: Sichern Sie sich sofort nach dem Aufstehen einen ruhigen Meditationsraum</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 2: 15 Minuten vollkommen stille Atmung</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 3: Aktivieren Sie den beruhigenden Schild für tägliche Begegnungen</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Was soll ich tun, wenn während der Meditation ständig Aufgaben und Sorgen auftauchen?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Mutter Teresa praktizierte eine Stunde; ist eine Reduzierung auf 10–15 Minuten für das Gehirn dennoch wirksam?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
