...
app: "buildself"
formatVersion: 4
authority: "Historische Biografien von Ayrton Senna, F1-Rennaufzeichnungen & Kognitive Neurowissenschaften und Sportpsychologie"
steps:
  - name: "Visuelle Störungen ausblenden und Atmung stabilisieren"
    text: "Lehnen Sie sich 10 Minuten vor der wichtigen Aufgabe zurück, schließen Sie die Augen und machen Sie 3 tiefe Bauchatmungen zur Beruhigung."
  - name: "Dreidimensionale Simulation des Prozesses in Ich-Perspektive"
    text: "Stellen Sie sich aus der Ich-Perspektive den ersten Bildschirminhalt, den ersten Satz und die ersten Gesten verlangsamt wie in einem 3D-Film vor."
  - name: "Reaktionen auf unvorhergesehene Situationen vorab einprogrammieren"
    text: "Stellen Sie sich unerwartete Störungen vor und simulieren Sie, wie Sie ruhig bleiben, durchatmen und die Ausweichreaktion gelassen ausführen."
faqs:
  - question: "Was tun, wenn die mentale Simulation stattdessen meine Angst verstärkt?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Visuelle Störungen ausblenden und Atmung stabilisieren</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Dreidimensionale Simulation des Prozesses in Ich-Perspektive</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Reaktionen auf unvorhergesehene Situationen vorab einprogrammieren</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Was tun, wenn die mentale Simulation stattdessen meine Angst verstärkt?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Was ist die empfohlene Dauer für jede mentale Probeeinheit?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
