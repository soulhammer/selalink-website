...
steps:
  - name: "Schritt 1: Auswahl Ihres persönlichen fokusoptimierten Orts"
    text: "Bestimmen Sie 1-2 Orte in der Nähe von Zuhause oder der Arbeit, die über Tische in angenehmer Höhe verfügen und ein sanftes, nicht störendes Hintergrundgeräusch ohne laute Musik aufweisen."
  - name: "Schritt 2: Aufbau eines Einstiegsskripts für den Hyperfokus"
    text: "Legen Sie eine feste Routine fest – wie das Hinsetzen, das Bestellen eines bestimmten Getränks (z. B. Kräutertee oder Americano) und das Einrichten Ihrer Arbeitsmittel –, um Ihr Gehirn dazu zu bringen, automatisch den Fokus-Schalter umzulegen."
  - name: "Schritt 3: Ausführung von tiefem Fokus & Ausführen von Lärm-Notfallplänen"
    text: "Führen Sie Ihre Aufgaben über einen festgelegten Zeitblock (2-4 Stunden) fokussiert aus und aktivieren Sie bei überschrittenem Lärmpegel sofort Noise-Cancelling-Geräte, um Ihren kognitiven Zustand zu schützen."
faqs:
  - question: "Warum wählte Simone de Beauvoir das Café de Flore als ihren Schreibort?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 1: Auswahl Ihres persönlichen fokusoptimierten Orts</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 2: Aufbau eines Einstiegsskripts für den Hyperfokus</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 3: Ausführung von tiefem Fokus & Ausführen von Lärm-Notfallplänen</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Warum wählte Simone de Beauvoir das Café de Flore als ihren Schreibort?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Kann ich ein ähnliches Kognitives Skript in einer Homeoffice-Umgebung umsetzen?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
