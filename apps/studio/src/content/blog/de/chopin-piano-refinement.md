...
steps:
  - name: "Schritt 1: Blockieren der Selbstzensur & Schnelles Erstellen eines Rohentwurfs"
    text: "Ignorieren Sie Perfektion und Fehlerkorrektur. Erstellen Sie das Grundgerüst, den Ablauf oder die Logik Ihres Dokuments, Codes oder Designs schnell und ohne Unterbrechung innerhalb eines Zeitlimits."
  - name: "Schritt 2: Aufteilung in Mikroeinheiten & Iterative Verfeinerung"
    text: "Unterteilen Sie den Entwurf in kleine Abschnitte (Absätze, Sätze oder Code-Module). Überprüfen und testen Sie jede Einheit wiederholt wie das Einüben einer Klavierpassage und entfernen Sie unpassende Elemente."
  - name: "Schritt 3: Ganzheitliche Überprüfung der strukturellen Integration & Finalisierung"
    text: "Fügen Sie die verfeinerten Abschnitte zu einem stimmigen Ganzen zusammen und überprüfen Sie, ob sich die Mikrodetails nahtlos in die Gesamtstruktur füügen, um die Arbeit abzuschließen."
faqs:
  - question: "Führt obsessiver Perfektionismus beim Überarbeiten nicht zu Verzögerungen und verpassten Fristen?"
...
## 1. Feedback-Iterationsschleifen und neuronale Feineinstellung im Anterioren Cingulären Kortex (ACC)
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 1: Blockieren der Selbstzensur & Schnelles Erstellen eines Rohentwurfs</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 2: Aufteilung in Mikroeinheiten & Iterative Verfeinerung</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 3: Ganzheitliche Überprüfung der strukturellen Integration & Finalisierung</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Führt obsessiver Perfektionismus beim Überarbeiten nicht zu Verzögerungen und verpassten Fristen?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">An welchem Punkt der Verfeinerung sollte man mit dem Anpassen aufhören und das Werk finalisieren?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
