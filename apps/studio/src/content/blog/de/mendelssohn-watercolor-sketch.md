...
app: "buildself"
formatVersion: 4
authority: "Historisch-kritische Biografie und autobiografische Aufzeichnungen zu Felix Mendelssohn & Forschung der kognitiven Neurowissenschaften"
steps:
  - name: "5 Minuten visuelle Beobachtung von Natur oder Objekten"
    text: "Öffnen Sie morgens nach dem Aufstehen das Fenster und wählen Sie einen Baum, eine Wolke oder ein Objekt auf dem Schreibtisch aus, um es 5 Minuten lang ruhig zu betrachten. Es ist eine Form der sensorischen Meditation, bei der Sie Formen und Farben ohne kritische Bewertung aufnehmen."
  - name: "Non-verbale sensorische Skizze"
    text: "Zeichnen Sie mit einem Notizbuch oder einer digitalen Zeichen-App sanft die Konturen des beobachteten Objekts nach. Wenn Sie Farbstifte oder Marker haben, füllen Sie leichte, harmonische Farben ein, um diese visuell-taktile Handlung abzuschließen."
  - name: "Unmittelbarer sensorischer Transfer auf die Hauptaufgabe (Musik, Coden, Planung)"
    text: "Räumen Sie direkt nach dem Skizzieren die Malutensilien weg und wechseln Sie sofort zu Ihrer Hauptaufgabe (Komponieren, Konzepterstellung, Programmieren). Das Gehirn überträgt die beim visuellen Skizzieren aktivierten neuronalen Verbindungen auf die Hauptarbeit und setzt neue Kreativität frei."
faqs:
  - question: "Können auch Personen ohne jegliches Zeichentalent von der morgendlichen Skizze profitieren?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">5 Minuten visuelle Beobachtung von Natur oder Objekten</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Non-verbale sensorische Skizze</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Unmittelbarer sensorischer Transfer auf die Hauptaufgabe (Musik, Coden, Planung)</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Können auch Personen ohne jegliches Zeichentalent von der morgendlichen Skizze profitieren?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Reicht eine Bleistift- oder Kugelschreiberzeichnung anstelle von Aquarell für die Kreuzstimulation aus?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
