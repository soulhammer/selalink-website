...
steps:
  - name: "Schritt 1: Vollständige Erfassung und Diagnose komplexer Prozessschritte"
    text: "Listen Sie jeden Teilschritt Ihres aktuellen Projekts, Ihrer Routine oder Ihres Arbeitsablaufs visuell auf, um Engpässe und kognitive Überlastungspunkte zu diagnostizieren."
  - name: "Schritt 2: Extrahierung & Chunking der 3–5 essenziellen Kernelemente"
    text: "Extrahieren Sie nur die 3 bis 5 Kernelemente, die 80 % der Ergebnisse ausmachen, und streichen Sie untergeordnete oder redundante Schritte vollständig."
  - name: "Schritt 3: Anwendung des vereinfachten 6-Punkte-Systems & Sofortige Ausführung"
    text: "Stellen Sie Ihren Prozess auf ein einfaches 6-Punkte-System um und führen Sie Aufgaben in einem reibungslosen Ablauf mit einem einzigen kognitiven Scan aus."
faqs:
  - question: "Was sollte ich tun, wenn ich befürchte, bei der Vereinfachung wichtige Informationen zu vergessen?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 1: Vollständige Erfassung und Diagnose komplexer Prozessschritte</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 2: Extrahierung & Chunking der 3–5 essenziellen Kernelemente</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 3: Anwendung des vereinfachten 6-Punkte-Systems & Sofortige Ausführung</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Was sollte ich tun, wenn ich befürchte, bei der Vereinfachung wichtige Informationen zu vergessen?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Kann dieses Framework zur Vereinfachung und zum Chunking auf Team-Arbeitsabläufe angewendet werden?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
