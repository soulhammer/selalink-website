...
steps:
  - name: "Schritt 1: Auswahl Ihres persönlichen Stücks zur morgendlichen emotionalen Ausrichtung"
    text: "Bestimmen Sie 1 bis 2 Stücke, die Ruhe und mathematische Symmetrie ausstrahlen – wie Bachs Präludien, ruhige Klassik oder akustische Klavierstücke – als Ihre morgendliche Musik."
  - name: "Schritt 2: 10 Minuten aktives Zuhören oder musikalisches Ausführen"
    text: "Schalten Sie nach dem Aufstehen oder vor Arbeitsbeginn 10 Minuten lang Smartphones aus und spielen Sie das ausgewählte Stück oder hören Sie mit geschlossenen Augen aufmerksam zu."
  - name: "Schritt 3: Übergang zu Hauptaufgaben im Alphawellen-Zustand"
    text: "Nutzen Sie direkt nach dem Ende der Musik Ihren kalibrierten Zustand und die Alphawellen, um ohne Umschweife zu Ihren Hauptaufgaben überzugehen."
faqs:
  - question: "Kann jemand, der kein Instrument spielt, von Casals' morgendlicher Musikroutine profitieren?"
...
## 1. Alphawellen-Induktion und Ausgleich des autonomen Nervensystems durch musikalische Entrainment-Prozesse
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 1: Auswahl Ihres persönlichen Stücks zur morgendlichen emotionalen Ausrichtung</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 2: 10 Minuten aktives Zuhören oder musikalisches Ausführen</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Schritt 3: Übergang zu Hauptaufgaben im Alphawellen-Zustand</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Kann jemand, der kein Instrument spielt, von Casals' morgendlicher Musikroutine profitieren?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Ist das Tragen von Kopfhörern beim morgendlichen Hören klassischer Musik effektiver?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
