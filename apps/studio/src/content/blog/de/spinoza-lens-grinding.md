...
app: "buildself"
formatVersion: 4
authority: "Historische Biographieforschung zu Spinozas Linsenschleifen & Kognitive Neurowissenschaften"
steps:
  - name: "Erkennen der kognitiven Überlastung des Gehirns"
    text: "Erkennen Sie Burnout-Signale frühzeitig, z. B. wenn gelesene Texte nicht verarbeitet werden, Ideen ausbleiben oder ein Gefühl von Leere im Kopf entsteht."
  - name: "Ausführung feinmotorischer Handarbeit"
    text: "Treten Sie sofort vom Bildschirm zurück und beginnen Sie eine analoge Handarbeit (z. B. Geschirrspülen, Abschreiben auf Papier, Zusammenbauen kleiner Modelle). Konzentrieren Sie sich 15 Minuten lang auf das Tasterlebnis."
  - name: "Rückkehr zu analytischen Aufgaben mit klarem Kopf"
    text: "Kehren Sie nach 15 Minuten Handarbeit an den Computer zurück und nehmen Sie Ihre Planungs- oder Entwicklungsarbeit wieder auf. Mit wiederhergestelltem kognitivem Puffer treffen Sie klarere Entscheidungen."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Erkennen der kognitiven Überlastung des Gehirns</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Ausführung feinmotorischer Handarbeit</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Rückkehr zu analytischen Aufgaben mit klarem Kopf</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Sollte ich diese Gewohnheit jeden Tag praktizieren?</span>
