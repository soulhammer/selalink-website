...
app: "buildself"
formatVersion: 4
authority: "Historische Biografien und autobiografische Aufzeichnungen von Jules Verne & Kognitive Neurowissenschaftliche Forschung"
steps:
  - name: "Tägliche komprimierte Informationskarten erstellen"
    text: "Fassen Sie Artikel oder wissenschaftliche Fakten, die Sie beim Lernen oder Forschen erworben haben, auf 10 cm großen analogen Notizzetteln oder digitalen Notizen zusammen und notieren Sie 2–3 Schlüsselwörter und die Quelle."
  - name: "Kategorisieren und Archivieren"
    text: "Beschriften Sie Ihre Wissenskarten mit Hauptkategorien (z. B. Kognitionswissenschaft, Marketing, Geografie) und Unterkategorien und ordnen Sie sie systematisch in dafür vorgesehene Boxen oder digitale Ordner ein."
  - name: "Wöchentliche Kartenfusion und Überprüfung"
    text: "Nehmen Sie am Wochenende oder zu festen Zeiten zufällig 5–6 gespeicherte Karten aus der Schublade, lesen Sie sie erneut und verbinden Sie scheinbar unzusammenhängende Informationen, um Denksynergien zu erzeugen oder sie beim Schreiben anzuwenden."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Tägliche komprimierte Informationskarten erstellen</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Kategorisieren und Archivieren</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Wöchentliche Kartenfusion und Überprüfung</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Wie unterscheidet sich Niklas Luhmanns Zettelkasten-Methode von Jules Vernes Karteikarten-Ausschnitten?</span>
