...
steps:
  - name: "Pertahankan kertas aluminium asli 📦"
    text: "Pembungkus aluminium asli sangat baik untuk menghalangi cahaya dan udara, mencegah oksidasi."
  - name: "Segel ganda untuk mencegah bau 📰"
    text: "Masukkan mentega ke dalam kantong atau wadah kedap udara agar tidak menyerap bau makanan lain."
  - name: "Potong menjadi beberapa bagian dan bekukan ❄️"
    text: "Untuk penyimpanan jangka panjang, potong mentega menjadi dadu, bungkus dengan kertas roti, lalu bekukan."
faqs:
...
Pernahkah Anda menyimpan mentega di pintu kulkas...
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Pertahankan kertas aluminium asli 📦</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Pembungkus aluminium asli sangat baik untuk menghalangi cahaya dan udara, mencegah oksidasi.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Segel ganda untuk mencegah bau 📰</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Masukkan mentega ke dalam kantong atau wadah kedap udara agar tidak menyerap bau makanan lain.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Potong menjadi beberapa bagian dan bekukan ❄️</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Untuk penyimpanan jangka panjang, potong mentega menjadi dadu, bungkus dengan kertas roti, lalu bekukan.
  </p>
</div>
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-rose-500 bg-rose-500/5 flex items-start gap-4">
  ...
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">Jangan simpan mentega di pintu kulkas ⚠️</strong>
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-amber-500 bg-amber-500/5 flex items-start gap-4">
  <span class="text-xl">⚠️</span>
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">Hindari kontaminasi silang saat memotong 🧈</strong>
    <p class="text-slate-700 dark:text-slate-300 text-sm m-0 leading-relaxed">
