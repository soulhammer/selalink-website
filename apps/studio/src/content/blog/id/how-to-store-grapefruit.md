...
title: "Cara Menyimpan Buah Lemon / Grapefruit agar Tetap Segar: Panduan Penyimpanan Ilmiah"
description: "Ketahui suhu, metode, dan masa simpan terbaik untuk grapefruit berdasarkan pedoman keselamatan resmi."
pubDate: "2026-07-16"
...
steps:
  ...
  - name: "Simpan di tempat sejuk dan gelap pada suhu 10–12°C — Penyimpanan Optimal (1–2 Minggu Suhu Ruang / 3–4 Minggu pada 10–12°C) 🌡️"
    text: "Rentang suhu ini mencegah kerusakan dingin sekaligus menjaga sari buah. 💡 Tips Penyimpanan: Simpan di tempat sejuk dengan sirkulasi udara baik (seperti rak bawah/lemari pendingin) pada suhu 10–12°C hingga 3–4 minggu."
  - name: "Habiskan dalam 10 hari jika menggunakan kulkas biasa (0–4°C) — Cegah Kerusakan Dingin ❄️"
    text: "Jika tidak ada tempat sejuk 10–12°C dan harus menggunakan kulkas biasa, kontrol waktu adalah kunci. 💡 Tips Penyimpanan: Bungkus dengan koran, letakkan di laci sayur, dan habiskan dalam 10 hari sebelum kerusakan dingin terjadi."
faqs:
  - question: "Kulit grapefruit saya memiliki bintik-bintik cokelat yang cekung. Apakah masih aman dimakan?"
    answer: "Ya, sangat aman dimakan! Bercak cekung (pitting) adalah gejala klasik kerusakan dingin akibat suhu di bawah 10°C. Ini bukan disebabkan oleh pembusukan jamur/bakteri, tetapi kebocoran naringin membuat daging buah terasa lebih pahit dan kurang berair."
  - question: "Bagaimana cara menyimpan sisa grapefruit yang sudah dipotong?"
    answer: "Setelah dipotong, daging buah kehilangan air dengan cepat dan teroksidasi. Bungkus bagian potong secara rapat dengan plastik wrap, masukkan ke wadah kedap udara di kulkas (0–4°C), dan habiskan dalam 2–3 hari."
---
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md transition-all">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">Bungkus setiap grapefruit satu per satu dengan kertas koran atau tisu dapur — Kontrol Kelembapan 🗞️</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md transition-all">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">Simpan di tempat sejuk dan gelap pada suhu 10–12°C — Penyimpanan Optimal (1–2 Minggu Suhu Ruang / 3–4 Minggu pada 10–12°C) 🌡️</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md transition-all">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">Habiskan dalam 10 hari jika menggunakan kulkas biasa (0–4°C) — Cegah Kerusakan Dingin ❄️</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
...
<div class="my-6 p-5 md:p-6 rounded-r-2xl rounded-l-md border-l-4 border-amber-500/30 bg-amber-500/5 dark:bg-amber-500/10 bg-amber-500/[0.06] dark:bg-amber-500/10 border-amber-500/30 flex items-start gap-4 shadow-xs backdrop-blur-xs">
  ...
  <div class="flex-1 min-w-0">
    <strong class="text-slate-950 dark:text-white font-extrabold block text-base md:text-lg mb-1.5 tracking-tight">Hindari penyimpanan jangka panjang di kulkas rumah pada suhu 0–4°C ⚠️</strong>
...
<div class="my-6 p-5 md:p-6 rounded-r-2xl rounded-l-md border-l-4 border-amber-500/30 bg-amber-500/5 dark:bg-amber-500/10 bg-amber-500/[0.06] dark:bg-amber-500/10 border-amber-500/30 flex items-start gap-4 shadow-xs backdrop-blur-xs">
  <span class="text-xl md:text-2xl flex-shrink-0 mt-0.5">⚠️</span>
  <div class="flex-1 min-w-0">
    <strong class="text-slate-950 dark:text-white font-extrabold block text-base md:text-lg mb-1.5 tracking-tight">Jangan pernah menutup rapat dalam kantong plastik di suhu ruang 💧</strong>
    <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base m-0 leading-relaxed font-normal break-words">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Kulit grapefruit saya memiliki bintik-bintik cokelat yang cekung. Apakah masih aman dimakan?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Bagaimana cara menyimpan sisa grapefruit yang sudah dipotong?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
