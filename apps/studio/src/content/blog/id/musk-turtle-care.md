...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-500/10 shadow-sm">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    ...
    <strong>• Tindakan:</strong> Hindari mengejutkan mereka agar tidak melompat kembali ke air. Pantau suhu lampu berjemur dari jarak jauh.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-500/10 shadow-sm">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    ...
    <strong>• Tindakan:</strong> Hindari gerakan tiba-tiba di depan akuarium dan mundur sampai mereka merasa cukup aman untuk mengintip keluar.
  </p>
</div>
