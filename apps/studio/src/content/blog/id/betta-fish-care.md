...
category: "FreshSelf"
tags: ["PerawatanHewan","KesehatanHewan","Ikan Betta / Cupang"]
...
steps:
  - name: "Komunikasi Cupang: Mengembangkan Insang (Flaring) & Istirahat Permukaan"
    text: "Mengembangkan insang dan sirip (Flaring) adalah tanda pertahanan teritorial. Latihan singkat 5 menit sehari bagus untuk otot sirip, namun flaring terus-menerus cause stress berat."
  - name: "Ikan Betta / Cupang's Body Language & Signals"
    text: "* Mengembangkan Insang & Sirip Mengembang Maksimal (Flaring): Peringatan teritorial atau respons stres agresif saat melihat cermin atau bayangan. (Jauhkan cermin atau benda reflektif agar waktu flaring terbatas di bawah 5 menit.)

* Tidur Diam di Atas Daun Dekat Permukaan Air (Labyrinth Resting): Istirahat normal untuk meringankan beban sirip sambil bernapas lewat labirin. (Redupkan lampu dan pastikan arus filter sponge tidak terlalu kencang.)"
  - name: "Customized 3-Step Home Care Routine"
    text: "* STEP 1. Pagi: Cek Suhu Air (24°C ~ 26°C) & Arus Filter Sponge: Pastikan pemanas berfungsi dan arus air dari filter sponge sangat tenang.

* STEP 2. Siang: Beri Pakan Pelet Khusus & Bersihkan Sisa Makanan: Beri 3 - 4 butir pelet khusus Cupang dan angkat sisa makanan dalam 5 menit.

* STEP 3. Malam: Cek Sarang Busa & Latihan Flaring 5 Menit: Gunakan cermin kecil selama 3 - 5 menit untuk melatih otot sirip agar tidak lengket."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-500/10 shadow-sm">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Komunikasi Cupang: Mengembangkan Insang (Flaring) & Istirahat Permukaan</h4>
  </div>
...
## 2. Ikan Betta / Cupang's Body Language & Signals
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-500/10 shadow-sm">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Mengembangkan Insang & Sirip Mengembang Maksimal (Flaring)</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    <strong>• Arti:</strong> Peringatan teritorial atau respons stres agresif saat melihat cermin atau bayangan.<br/>
    <strong>• Tindakan:</strong> Jauhkan cermin atau benda reflektif agar waktu flaring terbatas di bawah 5 menit.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-500/10 shadow-sm">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Tidur Diam di Atas Daun Dekat Permukaan Air (Labyrinth Resting)</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    <strong>• Arti:</strong> Istirahat normal untuk meringankan beban sirip sambil bernapas lewat labirin.<br/>
    <strong>• Tindakan:</strong> Redupkan lampu dan pastikan arus filter sponge tidak terlalu kencang.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/60 dark:border-slate-800/60 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none" role="button" aria-expanded="true">
      <span>Mengapa ujung sirip Cupang saya tampak mengikis dan menghitam?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none" role="button" aria-expanded="false">
      <span>Bolehkah memelihara Cupang di toples kecil tanpa filter?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400">▼</span>
    </summary>
    <p class="mt-3 text-sm text-slate-650 dark:text-slate-300 leading-relaxed pl-1">
