...
app: "buildself"
formatVersion: 4
authority: "Verifikasi biografi historis & catatan autobiografi Shohei Ohtani & penelitian neurosains kognitif (Cognitive Neuroscience)"
steps:
  - name: "Merancang Bagan Target Mandalart"
    text: "Gambar kisi 3x3 pada kertas atau tablet, tulis target utama di tengah, dan strukturkan sub-strategi terperinci di 8 kotak sekelilingnya untuk memvisualisasikan rencana aksi yang dapat segera dieksekusi."
  - name: "Membangun Lingkungan Tidur Kedap Cahaya dan Terkontrol Suhu"
    text: "Untuk memastikan tidur nyenyak berkualitas tinggi, pasang tirai kedap cahaya untuk memblokir pencahayaan secara total dan atur suhu ruangan pada 18°C yang sejuk dan nyaman."
  - name: "Mengombinasikan Tidur Siang untuk Mengisi Total Waktu Tidur"
    text: "Tidurlah lebih dari 8 jam di malam hari dan kombinasikan dengan tidur siang singkat selama 20–30 menit saat konsentrasi menurun di sore hari untuk memenuhi total 10 jam waktu pengisian daya tubuh harian."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Membangun Lingkungan Tidur Kedap Cahaya dan Terkontrol Suhu</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Mengombinasikan Tidur Siang untuk Mengisi Total Waktu Tidur</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Tidur 10 jam tampak tidak realistis bagi orang modern yang sibuk; apakah boleh dikurangi?</span>
