...
app: "buildself"
formatVersion: 4
authority: "Riset Berdasarkan Biografi Historis dan Catatan Autobiografi Schumpeter & Sains Saraf Kognitif"
steps:
  - name: "Langkah 1: Tinjauan Waktu Tanpa Emosi"
    text: "Setiap malam setelah selesai bekerja, periksa riwayat penggunaan ponsel atau kalender untuk mencatat aktivitas harian dalam interval 30 menit secara objektif."
  - name: "Langkah 2: Penilaian Diri Berdasarkan Rubrik Jelas"
    text: "Berikan nilai (A–F) untuk hari ini sesuai kriteria Anda (mis. Deep Work 4 jam = A, 2 jam = B, 3+ gangguan = D)."
  - name: "Langkah 3: Identifikasi Penyebab & Aturan Utama Besok"
    text: "Temukan penyebab utama nilai hari ini (mis. buang waktu 1 jam di medsos) dan buat langkah perbaikan, seperti menjauhkan ponsel selama 1 jam besok pagi."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 1: Tinjauan Waktu Tanpa Emosi</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 2: Penilaian Diri Berdasarkan Rubrik Jelas</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 3: Identifikasi Penyebab & Aturan Utama Besok</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Apa yang harus dilakukan jika saya berbuat curang atau terlalu toleran saat memberi nilai?</span>
