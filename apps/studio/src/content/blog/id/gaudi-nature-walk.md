...
steps:
  - name: "Langkah 1: Pemutusan Digital & Penentuan Rute Jalan 30–40 Menit"
    text: "Ubah ponsel pintar ke mode senyap dan simpan di saku. Kenakan sepatu berjalan yang nyaman dan pilih area hijau atau rute kota yang tenang yang memungkinkan Anda berjalan tanpa gangguan selama 30 hingga 40 menit."
  - name: "Langkah 2: Pengamatan Sadar terhadap Pola Organik & Arsitektur"
    text: "Saat Anda berjalan, amati struktur alami dan buatan di sekitar Anda. Arahkan pandangan Anda pada pola-pola struktural—sudut percabangan, tulang daun, tekstur awan, atau lengkungan arsitektur."
  - name: "Langkah 3: Penstrukturan Ide Secara Langsung dalam Kondisi Perfusi Tinggi Pasca-Jalan"
    text: "Segera setelah berjalan—saat oksigenasi otak dan aliran darah prefrontal mencapai puncaknya—duduklah dengan buku catatan. Gambarlah atau susun garis besar masalah atau proposal Anda."
faqs:
  - question: "Apakah wajib berjalan di taman alam atau jalan tanah agar metode ini berhasil?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 1: Pemutusan Digital & Penentuan Rute Jalan 30–40 Menit</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 2: Pengamatan Sadar terhadap Pola Organik & Arsitektur</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 3: Penstrukturan Ide Secara Langsung dalam Kondisi Perfusi Tinggi Pasca-Jalan</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Apakah wajib berjalan di taman alam atau jalan tanah agar metode ini berhasil?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Bisakah saya mengganti rutinitas berjalan ini dengan lari cepat atau treadmill?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
