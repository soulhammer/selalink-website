...
app: "buildself"
formatVersion: 4
authority: "Riset Biografi Historis dan Catatan Autobiografi Gregor Mendel & Studi Neurosains Kognitif"
steps:
  - name: "Pilih Metrik Pelacakan Mikro"
    text: "Pilih satu metrik kuantitatif yang spesifik dan sederhana yang memberikan nilai tambah melalui pemantauan harian (misalnya, jam fokus belajar, pengeluaran harian, gram konsumsi protein, atau jumlah halaman buku yang dibaca)."
  - name: "Pencatatan Tangan pada Buku Analog"
    text: "Pada waktu yang ditentukan setiap malam, buka buku catatan bergaris dan tuliskan angka yang tepat dengan pulpen, alih-alih menggunakan aplikasi ponsel. Berfokuslah pada tindakan fisik menulis angka untuk memperkuat memori kognitif di lobus frontal."
  - name: "Analisis Pola Mingguan dan Visualisasi"
    text: "Di akhir pekan, tinjau angka-angka yang dicatat selama seminggu dan gambar grafik garis atau tabel dengan tangan untuk memvisualisasikannya. Analisis faktor apa yang menyebabkan penyimpangan pada hari tertentu, sambil mempelajari pola kognitif statistik tingkat tinggi."
faqs:
  - question: "Apakah saya harus menggambar grafik dengan tangan? Bukankah menggunakan Excel lebih praktis?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Pilih Metrik Pelacakan Mikro</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Pencatatan Tangan pada Buku Analog</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Analisis Pola Mingguan dan Visualisasi</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Apakah saya harus menggambar grafik dengan tangan? Bukankah menggunakan Excel lebih praktis?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Apakah perlu tetap mencatat meskipun tidak ada perubahan angka yang signifikan?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
