...
app: "buildself"
formatVersion: 4
authority: "Verifikasi biografi historis & catatan autobiografi latihan terbit matahari Nelson Mandela & penelitian ilmu saraf kognitif"
steps:
  - name: "Pemblokiran Ponsel Pintar dan Penguatan Fisik"
    text: "Jangan melihat layar ponsel pintar setidaknya selama 15 menit segera setelah bangun di pagi hari. Bangunkan otak yang tertidur secara lembut melalui peregangan ringan dan napas dalam."
  - name: "Rutinitas Kekuatan Bebas Bobot Tubuh 15 Menit"
    text: "Ulangi satu set latihan beban tubuh sederhana sebanyak 3 kali: 10 kali push-up, 15 kali squat, dan 30 detik plank. Kontraksi dan relaksasi otot tubuh secara langsung secara efektif mendorong sekresi dopamin."
  - name: "Ikrar Komitmen Otonomi Aktif"
    text: "Setelah menyelesaikan latihan, tentukan 1 hingga 2 prioritas utama yang harus Anda capai hari ini. Perkuat kemauan Anda dengan mengingatkan diri sendiri bahwa kendali penuh atas hidup Anda berada sepenuhnya di tangan Anda."
faqs:
  - question: "Haruskah saya memaksakan diri bangun jam 5 pagi untuk berolahraga meskipun kurang tidur?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Pemblokiran Ponsel Pintar dan Penguatan Fisik</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Rutinitas Kekuatan Bebas Bobot Tubuh 15 Menit</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Ikrar Komitmen Otonomi Aktif</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Haruskah saya memaksakan diri bangun jam 5 pagi untuk berolahraga meskipun kurang tidur?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Bagaimana pemula dengan stamina fisik lemah harus memulai rutinitas ini?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
