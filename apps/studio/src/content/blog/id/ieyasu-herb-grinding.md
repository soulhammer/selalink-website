...
app: "buildself"
formatVersion: 4
authority: "Verifikasi Historis dari Biografi Tokugawa Ieyasu, Arsip Museum Seni Tokugawa & Penelitian Neurosains Kognitif"
steps:
  - name: "Langkah 1: Menyiapkan Bahan-Bahan dan Alat Penggiling Manual"
    text: "Setiap pagi, atur daun teh, biji kopi, atau herbal kering Anda dengan tenang bersama lumpang manual atau penggiling tangan."
  - name: "Langkah 2: Gerakan Berirama Manual Rotasi Kecepatan Konstan Selama 5 Menit"
    text: "Pertahankan kecepatan dan tekanan yang konsisten selama 5 menit, menumbuk bahan-bahan secara halus dalam gerakan melingkar. Terbenamkan perhatian Anda secara total pada irama gesekan."
  - name: "Langkah 3: Mengonsumsi Seduhan Buatan Tangan & Penyelesaian Napas Dalam"
    text: "Tuangkan air hangat di atas racikan yang ditumbuk halus untuk menyeduhnya. Nikmati aroma dan rasa sambil menarik napas dalam-dalam, menyelesaikan transisi otak Anda menuju kewaspadaan yang tenang."
faqs:
  - question: "Bagaimana tindakan fisik menumbuk obat herbal secara pribadi berkontribusi pada stabilitas emosional?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 1: Menyiapkan Bahan-Bahan dan Alat Penggiling Manual</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 2: Gerakan Berirama Manual Rotasi Kecepatan Konstan Selama 5 Menit</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 3: Mengonsumsi Seduhan Buatan Tangan & Penyelesaian Napas Dalam</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Bagaimana tindakan fisik menumbuk obat herbal secara pribadi berkontribusi pada stabilitas emosional?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Bagaimana cara mereplikasi rutinitas ini dalam kehidupan sehari-hari jika saya tidak memiliki lumpang?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
