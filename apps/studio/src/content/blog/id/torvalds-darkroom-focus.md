...
app: "buildself"
formatVersion: 4
authority: "Biografi historis dan catatan autobiografi Linus Torvalds & penelitian Ilmu Saraf Kognitif"
steps:
  - name: "Hapus Sepenuhnya Dekorasi Visual di Sekitar Meja"
    text: "Bersihkan sepenuhnya bingkai foto berwarna-warni, figur mainan, sampul buku di rak, ponsel pintar, dan gangguan lainnya dari meja dan garis pandang Anda. Hanya tempatkan monitor, tetikus, dan papan ketik Anda."
  - name: "Kontrol Pencahayaan Sekitar dan Bangun Lingkungan Kamar Gelap"
    text: "Tutup tirai blackout atau matikan lampu utama ruangan untuk meredupkan pencahayaan sekitar secara signifikan. Atur agar hanya cahaya layar monitor yang terlihat, atau nyalakan satu lampu tidak langsung yang lembut di belakang atau di bawah meja untuk mencegah kelelahan mata."
  - name: "Tenggelam dalam Antarmuka Digital Tunggal"
    text: "Daripada memenuhi layar Anda dengan banyak jendela yang terbuka, jalankan hanya editor kode atau editor dokumen yang sedang Anda kerjakan dalam mode layar penuh. Tempatkan hanya satu stimulasi teks inti di depan mata Anda untuk mencegah terpecahnya perhatian."
faqs:
  - question: "Apakah melihat monitor di ruang gelap merusak penglihatan?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Hapus Sepenuhnya Dekorasi Visual di Sekitar Meja</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Kontrol Pencahayaan Sekitar dan Bangun Lingkungan Kamar Gelap</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Tenggelam dalam Antarmuka Digital Tunggal</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Apakah melihat monitor di ruang gelap merusak penglihatan?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Apa yang harus saya lakukan jika tidak memiliki ruang cuci atau ruang terisolasi di rumah?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
