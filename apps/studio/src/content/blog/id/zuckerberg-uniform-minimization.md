...
app: "buildself"
formatVersion: 4
authority: "Biografi historis & catatan autobiografi tentang minimisasi seragam Zuckerberg & penelitian ilmu saraf kognitif (Cognitive Neuroscience)"
steps:
  - name: "Pilih Seragam Dasar yang Sederhana & Nyaman"
    text: "Tentukan kombinasi dasar kaus bernuansa netral yang sederhana dan nyaman dengan jeans atau celana bahan yang dapat Anda kenakan tanpa ragu saat bekerja atau bepergian."
  - name: "Beli Banyak Pakaian Identik & Tempatkan di Barisan Depan"
    text: "Beli beberapa stel kaus dan celana yang identik, lalu gantung berdampingan di bagian depan lemari yang paling mudah dijangkau."
  - name: "Nolkan Pengambilan Keputusan Pakaian di Pagi Hari"
    text: "Begitu bangun pagi, langsung ambil seragam yang tergantung di barisan depan tanpa ragu, menjaga anggaran glukosa korteks prefrontal Anda dan memulai hari dengan segar."
faqs:
  - question: "Jika saya mengenakan pakaian yang sama setiap hari, bagaimana cara menghadapi rapat penting atau acara formal?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Pilih Seragam Dasar yang Sederhana & Nyaman</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Beli Banyak Pakaian Identik & Tempatkan di Barisan Depan</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Nolkan Pengambilan Keputusan Pakaian di Pagi Hari</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Jika saya mengenakan pakaian yang sama setiap hari, bagaimana cara menghadapi rapat penting atau acara formal?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Apakah saya boleh menyusun seragam menggunakan pakaian selain kaus dan jeans?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
