...
app: "buildself"
formatVersion: 4
authority: "Verifikasi Biografi Historis Agnes Martin & Riset Neurosains Kognitif"
steps:
  - name: "Melakukan Ritual Hening Fisik 5 Menit Sebelum Bekerja"
    text: "Matikan layar komputer dan perangkat elektronik, duduk tegak di kursi yang nyaman, dan hentikan seluruh gerakan fisik secara sadar."
  - name: "Melepaskan Kebisingan Otak secara Kognitif"
    text: "Saat kekhawatiran tentang tugas atau rencana harian melintas, hindari menilai pikiran tersebut; biarkan berlalu dan tunggulah dalam keheningan hingga kebisingan mereda."
  - name: "Memulai Pekerjaan dengan Kondisi Prefrontal yang Jernih"
    text: "Setelah kabut mental sirna dan fokus yang jernih tercapai, bukalah hanya satu tugas inti yang paling esensial dan mulailah bekerja."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Melakukan Ritual Hening Fisik 5 Menit Sebelum Bekerja</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Melepaskan Kebisingan Otak secara Kognitif</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Memulai Pekerjaan dengan Kondisi Prefrontal yang Jernih</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Bagaimana pekerja yang sibuk dapat mempersingkat rutinitas Martin jika tidak memiliki waktu berjam-jam untuk bermeditasi?</span>
