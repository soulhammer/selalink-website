...
steps:
  - name: "Langkah 1: Hidrasi Setelah Bangun & 30 Menit Menghilangkan Inersia Tidur"
    text: "Minumlah segelas air hangat tepat setelah bangun untuk memulihkan hidrasi, dan beri waktu 30 menit agar inersia tidur menghilang seiring meredanya puncak kortisol alami."
  - name: "Langkah 2: Asupan Kafein Melalui Kopi Hitam yang Diseduh dengan Teliti"
    text: "Seduh dan nikmati secangkir kopi hitam atau espresso tanpa gula. Membutuhkan waktu sekitar 15 hingga 20 menit bagi kafein untuk terserap dan mencapai reseptor otak."
  - name: "Langkah 3: Mengeksekusi Jalan-Jalan Konseptual Cepat selama 15-20 Menit"
    text: "Setelah minum kopi, pergilah ke luar untuk berjalan cepat selama 15 hingga 20 menit dengan kecepatan yang sedikit meningkat. Saat aliran darah dan BDNF melonjak, buatlah kerangka kognitif secara mental untuk tugas-tugas utama hari itu."
faqs:
  - question: "Mengapa Brahms secara gigih bersikeras untuk menyeduh kopinya sendiri daripada membiarkan orang lain melakukannya?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 1: Hidrasi Setelah Bangun & 30 Menit Menghilangkan Inersia Tidur</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 2: Asupan Kafein Melalui Kopi Hitam yang Diseduh dengan Teliti</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Langkah 3: Mengeksekusi Jalan-Jalan Konseptual Cepat selama 15-20 Menit</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Mengapa Brahms secara gigih bersikeras untuk menyeduh kopinya sendiri daripada membiarkan orang lain melakukannya?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">Bagaimana secara spesifik jalan pagi berkontribusi pada stimulasi otak dan kreativitas?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
