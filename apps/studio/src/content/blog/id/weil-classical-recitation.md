...
app: "buildself"
formatVersion: 4
authority: "Catatan Biografis Historis Simone Weil & Riset Neurosains Kognitif"
steps:
  - name: "Memilih Kutipan Pendek atau Teks Klasik untuk Dibaca Pagi Hari"
    text: "Siapkan 1 hingga 2 kalimat mendalam atau kutipan di meja Anda pada malam sebelumnya. Gunakan kalimat padat pemikiran daripada berita harian."
  - name: "Membaca Teks Nyaring Secara Perlahan 5 Kali Sambil Merasakan Getaran Suara"
    text: "Ucapkan setiap kata dengan jelas tanpa tergesa-gesa. Rasakan getaran tenggorokan, gerakan bibir, dan suara yang masuk untuk mengusir pikiran pengganggu."
  - name: "Memejamkan Mata Selama 2 Menit Setelah Deklamasi untuk Menjaga Ketenangan"
    text: "Setelah selesai membaca nyaring, duduk tegak di meja, pejamkan mata, dan bernapas dalam selama 2 menit sebelum memulai tugas pertama Anda."
faqs:
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Memilih Kutipan Pendek atau Teks Klasik untuk Dibaca Pagi Hari</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Membaca Teks Nyaring Secara Perlahan 5 Kali Sambil Merasakan Getaran Suara</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Memejamkan Mata Selama 2 Menit Setelah Deklamasi untuk Menjaga Ketenangan</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">Mengapa Simone Weil lebih menyukai teks klasik Yunani Kuno untuk deklamasi pagi hari?</span>
