...
app: "petself"
formatVersion: 4
authority: "영국 동물학대방지협회 (RSPCA) 및 국제 소동물 수의학회 (WSAVA) 데구 케어 프로토콜"
steps:
  - name: "데구의 바디 랭귀지: 꼬리 흔들기·기쁨의 울음(Tail Wagging / Chirping)과 몸 굳힘·경고음(Freezing / Alarm Whistle)"
    text: "데구는 다양한 울음소리와 꼬리 움직임으로 감정과 스트레스를 명확하게 표현합니다. 동료나 보호자를 향해 꼬리를 좌우로 흔들며 새소리 같은 높은 울음소리를 내는 '꼬리 흔들기 및 기쁨의 울음(Tail Wagging / Chirping)'은 강한 유대감과 반가움을 나타내는 친화 신호입니다. 반면 제자리에 얼어붙은 채 날카롭고 고음의 경고음을 연속으로 내지르는 '몸 굳힘 및 경고음(Freezing / Alarm Whistle)'은 갑작스러운 소음, 상공의 그림자, 극심한 공포나 영역 침범에 대한 긴급 경고 신호입니다."
  - name: "데구 (Degu / Octodon degus)의 몸짓 언어와 바디 시그널"
    text: "* 꼬리를 좌우로 흔들며 청아한 새소리 같은 울음소리를 냄 (Tail Wagging / Chirping): 동료나 보호자에 대한 높은 신뢰, 반가움, 유대감 형성 및 기분 좋은 상태를 나타내는 긍정적 신호입니다. (다정하게 이름을 불러주며 무설탕 이갈이 수제 간식이나 티모시 건초를 제공해 교감을 강화합니다.)

* 몸을 딱딱하게 굳힌 채 고음의 날카로운 경고음을 내지름 (Freezing / Alarm Whistle): 상공의 그림자, 갑작스러운 진동, 외부 소음으로 인한 극심한 공포와 위험 경고 신호입니다. (시야를 가리는 자극 요인을 치우고 케이지를 어둡게 가려 안정을 취하게 하며, 놀라서 꼬리를 잡지 않도록 주의합니다.)"
  - name: "데구 (Degu / Octodon degus) 맞춤형 3단계 홈케어 루틴"
    text: "* STEP 1. 아침: 무제한 티모시 건초·무설탕 전용 펠릿 급여 및 주황색 치아 상태 점검: 당뇨 예방을 위해 과일과 당분이 완전히 배제된 티모시 건초와 전용 펠릿을 제공하며, 건강한 주황색 이갈이 치아 상태를 확인합니다.

* STEP 2. 낮: 대형 챗바퀴·이갈이 목재 점검 및 사회적 교감 환경 유지: 운동 부족과 스트레스 방지를 위해 대형 무소음 챗바퀴(30cm 이상)와 천연 이갈이 나무를 제공하고, 외로움을 타지 않도록 동료와 지낼 수 있게 돕습니다.

* STEP 3. 저녁: 전용 화산재 모래목욕탕 제공 및 꼬리 건강 모니터링: 피지 제거와 위생을 위해 물목욕 대신 미세 화산재 모래목욕탕을 제공하고, 꼬리 피모와 상처 여부를 점검합니다."
faqs:
  - question: "데구에게 과일이나 말린 채소를 간식으로 줘도 되나요?"
    answer: "절대 주면 안 됩니다! 데구는 당을 분해하는 인슐린 시스템이 매우 취약하여 아주 적은 양의 과일, 당근, 옥수수, 단 간식으로도 치명적인 당뇨병과 백내장을 유발합니다. 간식으로는 당분이 전혀 없는 건조 산야초, 뿌리류, 티모시 이갈이 링만 급여해야 합니다."
  - question: "데구의 꼬리를 실수로 잡았는데 피가 나고 가죽이 벗겨졌어요. 어떻게 하나요?"
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">데구의 바디 랭귀지: 꼬리 흔들기·기쁨의 울음(Tail Wagging / Chirping)과 몸 굳힘·경고음(Freezing / Alarm Whistle)</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">꼬리를 좌우로 흔들며 청아한 새소리 같은 울음소리를 냄 (Tail Wagging / Chirping)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        동료나 보호자에 대한 높은 신뢰, 반가움, 유대감 형성 및 기분 좋은 상태를 나타내는 긍정적 신호입니다.
      </p>
    </div>
    <div class="p-4 md:p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-950/30">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        다정하게 이름을 불러주며 무설탕 이갈이 수제 간식이나 티모시 건초를 제공해 교감을 강화합니다.
      </p>
    </div>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">몸을 딱딱하게 굳힌 채 고음의 날카로운 경고음을 내지름 (Freezing / Alarm Whistle)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      <div class="flex items-center gap-2 mb-2">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        상공의 그림자, 갑작스러운 진동, 외부 소음으로 인한 극심한 공포와 위험 경고 신호입니다.
      </p>
    </div>
    <div class="p-4 md:p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-950/30">
      <div class="flex items-center gap-2 mb-2">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        시야를 가리는 자극 요인을 치우고 케이지를 어둡게 가려 안정을 취하게 하며, 놀라서 꼬리를 잡지 않도록 주의합니다.
      </p>
    </div>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    <span class="px-3.5 py-1.5 text-xs font-black tracking-wider bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300 rounded-full border border-indigo-500/30 shadow-xs">ROUTINE 1</span>
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">아침: 무제한 티모시 건초·무설탕 전용 펠릿 급여 및 주황색 치아 상태 점검</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">낮: 대형 챗바퀴·이갈이 목재 점검 및 사회적 교감 환경 유지</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">저녁: 전용 화산재 모래목욕탕 제공 및 꼬리 건강 모니터링</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">데구에게 과일이나 말린 채소를 간식으로 줘도 되나요?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">데구의 꼬리를 실수로 잡았는데 피가 나고 가죽이 벗겨졌어요. 어떻게 하나요?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
