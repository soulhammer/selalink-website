...
steps:
  ...
  - name: "알맹이 분리 후 수분 제거하여 밀폐 용기 냉장 보관하기 — PPO 산화 억제 (1 ~ 2주) ❄️"
    text: "석류 알맹이의 산화 갈변을 막으려면 산소 접촉과 효소 활성을 최소화해야 합니다. 💡 보관 팁: 분리한 석류 알맹이의 물기를 키친타월로 완벽히 닦아낸 뒤, 밀폐 용기나 산소 흡착 밀폐 용기에 담아 냉장 보관(0 ~ 4℃)하세요. PPO 효소 활성이 억제되어 1 ~ 2주간 붉은 빛깔과 영양소를 유지합니다."
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md transition-all">
  ...
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    석류 알맹이의 산화 갈변을 막으려면 산소 접촉과 효소 활성을 최소화해야 합니다. 💡 보관 팁: 분리한 석류 알맹이의 물기를 키친타월로 완벽히 닦아낸 뒤, 밀폐 용기나 산소 흡착 밀폐 용기에 담아 냉장 보관(0 ~ 4℃)하세요. PPO 효소 활성이 억제되어 1 ~ 2주간 붉은 빛깔과 영양소를 유지합니다.
  </p>
</div>
