...
app: "buildself"
formatVersion: 4
authority: "헨리 데이비드 소로 역사적 평전 및 자서전 기록 고증 & 인지신경과학(Cognitive Neuroscience) 연구"
steps:
  ...
  - name: "스마트폰을 완전히 격리하고 걷는 행위와 오감에 집중하기"
    text: "산책 중에는 스마트폰 사용을 완전히 멈추고 주머니 속에 격리합니다. 발바닥에 가닿는 대지의 감각, 바람의 차가움, 나뭇잎 스치는 청각 자극에만 신경을 기울입니다."
  - name: "산책 도중 떠오르는 발상을 주머니 속 수첩에 즉각 메모하기"
    text: "아날로그 소형 수첩과 펜을 휴대합니다. 뇌가 이완되어 번뜩이는 지적 아이디어가 나오는 찰나에 스마트폰을 켜기보다 종이 위에 바로 기록합니다."
faqs:
  - question: "소로는 4시간 동안 걸으면서 어떻게 메모를 작성했나요?"
    answer: "그는 코트 주머니에 작은 수제 가죽 수첩과 연필을 넣고 걸었습니다. 영감이 떠오르면 걸음을 멈추고 나무 아래 서서 식물의 세부 사항이나 떠오른 문장을 즉시 기록했습니다."
---
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    산책 중에는 스마트폰 사용을 완전히 멈추고 주머니 속에 격리합니다. 발바닥에 가닿는 대지의 감각, 바람의 차가움, 나뭇잎 스치는 청각 자극에만 신경을 기울입니다.
  </p>
</div>
