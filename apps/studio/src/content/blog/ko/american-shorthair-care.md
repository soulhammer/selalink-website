...
title: "아메리칸 쇼트헤어 심장 및 비만 케어: HCM 예방과 체중 조절을 위한 3단계 루틴"
...
steps:
  - name: "아메리칸 쇼트헤어의 바디 랭귀지: 심장 과부하와 개구호흡의 의미"
    text: "고양이는 강아지와 달리 땀이나 헐떡임으로 온도를 조절하지 않으므로, 일상에서 입을 벌려 숨을 쉬는 '개구호흡'을 하거나 놀이 중 '쉽게 지쳐 엎드리는 현상'은 심장 질환의 강력한 경고입니다. 이를 조기에 알아채는 것이 중요합니다."
  - name: "아메리칸 쇼트헤어 (American Shorthair)의 몸짓 언어와 바디 시그널"
    text: "* 개구호흡 (Open-Mouth Breathing): 입을 벌리고 가쁜 숨을 몰아쉬는 상태로, 폐와 심장의 과부하 또는 극도의 불안으로 인한 심각한 산소 부족 신호입니다. (이동장이나 케이지에 넣어 스트레스를 최소화한 상태로 즉시 가까운 24시간 동물병원으로 이송하여 산소 치료를 받아야 합니다.)

* 쉽게 지쳐 엎드리기 (Quick Fatigue): 가벼운 깃털 놀이 등 짧은 움직임 뒤에도 바로 옆으로 누워 헐떡거리는 현상으로, 심장 박출량이 부족하다는 신호입니다. (격렬한 운동을 제한하고, 연 1회 청진 및 심장 초음파(proBNP 검사 포함)를 통해 비대성 심근증 진행 여부를 정밀 확인합니다.)"
  - name: "아메리칸 쇼트헤어 (American Shorthair) 맞춤형 3단계 홈케어 루틴"
    text: "* STEP 1. 아침: 자율 급식 제한 및 정량 사료 공급: 사료를 항상 채워두는 자율 급식 대신 아침저녁 정량으로 나누어 공급하여 비만을 사전에 방지하고 혈관 건강을 보호합니다.

* STEP 2. 낮: 사냥 본능 자극을 통한 15분 active 놀이: 낚싯대나 쥐 장난감을 공중에 날리는 등의 사냥 놀이를 하루 최소 2회, 15분 이상 유도하여 칼로리 소비를 촉진합니다.

* STEP 3. 저녁: 단모종 전용 슬리커 빗질 및 모질 관리: 단모종이지만 털의 밀도가 매우 높으므로 주 1 ~ 2회 빗질로 죽은 속털을 제거하여 헤어볼 구토로 인한 위장 장애를 예방합니다."
faqs:
  - question: "고양이 비대성 심근증(HCM)이란 무엇인가요?"
    answer: "심장의 좌심실 벽이 비정상적으로 두꺼워지면서 심장 내부 공간이 좁아져 전신으로 피를 보내지 못하게 되는 대표적인 유전성 질환입니다. 심하면 급사에 이를 수 있어 조기 정기 검진이 최선입니다."
  - question: "아메리칸 쇼트헤어의 비만 예방 식단 팁이 있을까요?"
...
<div class="my-8 p-6 md:p-7 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-r from-emerald-500/10 via-emerald-500/5 to-transparent dark:border-emerald-500/30 dark:from-emerald-950/30 dark:to-slate-900/40 flex items-start sm:items-center gap-4 shadow-xs backdrop-blur-md">
  ...
  <div class="flex-1 min-w-0">
    ...
    <p class="text-xs md:text-sm text-emerald-800/90 dark:text-emerald-300/90 font-medium m-0 mt-1.5 leading-relaxed break-words">
      본 콘텐츠는 CFA(국제고양이애호가협회) 아메리칸 쇼트헤어 품종 표준 및 코넬 고양이 건강 센터 연구에 기반하고 있습니다.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">아메리칸 쇼트헤어의 바디 랭귀지: 심장 과부하와 개구호흡의 의미</h4>
  </div>
...
## 2. 아메리칸 쇼트헤어 (American Shorthair)의 몸짓 언어와 바디 시그널
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">개구호흡 (Open-Mouth Breathing)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        입을 벌리고 가쁜 숨을 몰아쉬는 상태로, 폐와 심장의 과부하 또는 극도의 불안으로 인한 심각한 산소 부족 신호입니다.
      </p>
    </div>
    <div class="p-4 md:p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-950/30">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        이동장이나 케이지에 넣어 스트레스를 최소화한 상태로 즉시 가까운 24시간 동물병원으로 이송하여 산소 치료를 받아야 합니다.
      </p>
    </div>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">쉽게 지쳐 엎드리기 (Quick Fatigue)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      <div class="flex items-center gap-2 mb-2">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        가벼운 깃털 놀이 등 짧은 움직임 뒤에도 바로 옆으로 누워 헐떡거리는 현상으로, 심장 박출량이 부족하다는 신호입니다.
      </p>
    </div>
    <div class="p-4 md:p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-950/30">
      <div class="flex items-center gap-2 mb-2">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        격렬한 운동을 제한하고, 연 1회 청진 및 심장 초음파(proBNP 검사 포함)를 통해 비대성 심근증 진행 여부를 정밀 확인합니다.
      </p>
    </div>
  </div>
</div>
...
## 3. 아메리칸 쇼트헤어 (American Shorthair) 맞춤형 3단계 홈케어 루틴

<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    <span class="px-3.5 py-1.5 text-xs font-black tracking-wider bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300 rounded-full border border-indigo-500/30 shadow-xs">ROUTINE 1</span>
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">아침: 자율 급식 제한 및 정량 사료 공급</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">낮: 사냥 본능 자극을 통한 15분 active 놀이</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">저녁: 단모종 전용 슬리커 빗질 및 모질 관리</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">고양이 비대성 심근증(HCM)이란 무엇인가요?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">아메리칸 쇼트헤어의 비만 예방 식단 팁이 있을까요?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
