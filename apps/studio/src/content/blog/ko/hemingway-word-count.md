---
formatVersion: 4
title: "매일 쓴 단어 수를 차트에 기록하며 스스로를 모니터링하기 (헤밍웨이 루틴)"
description: "노벨상 수상 작가 어네스트 헤밍웨이가 매일 아침 자신의 글쓰기 단어 수를 기록했던 습관에 대해 알아봅니다."
pubDate: "2026-02-05"
category: "BuildSelf"
tags: ["위인 습관", "헤밍웨이", "글쓰기", "생산성", "자기관찰"]
heroImage: "/images/blog/hemingway_word_count.webp"
app: "buildself"
authority: "어네스트 헤밍웨이의 Paris Review 인터뷰 (1958) 및 응용 행동 분석 학술지 (JABA)"
---
...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      본 콘텐츠는 어네스트 헤밍웨이의 <strong>&lt;The Paris Review 인터뷰 (1958)&gt;</strong> 내용 및 응용 행동 분석 학술지(JABA)에 게재된 자기 모니터링이 행동 지속성에 미치는 영향 연구를 바탕으로 작성되었습니다.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">하루의 핵심 성과 정량적으로 측정하기</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">눈에 보이는 차트에 정직하게 기록하기</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">결과와 무관하게 기록하는 행위 자체에 집중하기</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
