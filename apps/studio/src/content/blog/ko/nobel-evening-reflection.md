...
steps:
  - name: "하루 실행 기록 및 메타 데이터 모으기"
    text: "저녁 시간 책상에 앉아 오늘 작성한 메모, 프로젝트 진행 내역을 훑어봅니다. 외부의 산만 요소를 철저히 차단하고, 뇌의 전두엽에 명확한 실행 목표와 프레임을 확립하는 데 온전히 집중합니다."
  - name: "5줄 요약 핵심 메타인지 일지 작성"
    text: "오늘 잘된 점 2가지, 막혔던 점 1가지, 내일의 수정 행동 2가지를 5줄로 명확히 적습니다."
  - name: "내일의 핵심 미션 선명화"
    text: "복기를 마친 후 내일 아침 제일 먼저 수행할 단 하나의 중요 과제를 적고 일지장을 덮습니다."
faqs:
  - question: "반드시 5개 국어나 외국어로 써야 하나요?"
    answer: "아닙니다. 모국어로 작성하되 '자신의 언어로 표현을 다듬는 행위' 자체가 핵심입니다. 여유가 있다면 익히고 있는 외국어로 1줄 적어보는 것도 뇌 자극에 좋습니다."
  - question: "매일 일지를 쓰다가 지치면 어떻게 해야 하나요?"
    answer: "장문의 글 대신 3개의 핵심 키워드만 적는 '키워드 복기'로 분량을 최소화하여 부담을 줄이세요."
---

"하루의 실수와 시도를 객관적인 기록으로 복기할 때, 비로소 불확실성은 위대한 발명으로 승화된다." 🧪

다이나마이트를 발명하고 인류의 평화와 학문적 위업을 칭송하는 노벨상을 창설한 스웨덴의 위대한 발명가이자 사업가, 알프레드 노벨(Alfred Nobel, 1833–1896). 평생 355개의 특허를 획득했던 그의 압도적인 메타인지와 독창적 발명 직관은 과연 어디서 탄생했을까요?

노벨은 낮 동안의 위험천만한 화학 실험과 지친 비즈니스 회의가 끝나면, 매일 저녁 서재로 돌아와 당일의 실험 일지와 메모를 꼼꼼히 재검토했습니다. 그는 스웨덴어, 영어, 프랑스어, 독일어, 러시아어로 일지를 번갈아 쓰며 하루 동안 얻은 지식과 오류를 정교하게 재구성했습니다. 저녁 서재에서의 15분 일지 복기는 한낮의 혼란을 정제하고 뇌의 신경 회로를 재정렬하는 그만의 최고 메타인지 훈련이었습니다.

오늘 포스트에서는 알프레드 노벨의 저녁 일지 복기 루틴과 메타인지 강화의 과학을 소개합니다.
...
<div class="my-8 p-6 md:p-7 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-r from-indigo-500/10 via-indigo-500/5 to-transparent dark:border-indigo-500/30 dark:from-indigo-950/30 dark:to-slate-900/40 flex items-start sm:items-center gap-4 shadow-xs backdrop-blur-md">
  ...
  <div class="flex-1 min-w-0">
    ...
    <p class="text-xs md:text-sm text-indigo-800/90 dark:text-indigo-300/90 font-medium m-0 mt-1.5 leading-relaxed break-words">
      본 콘텐츠는 알프레드 노벨 역사적 평전 및 자서전 기록 고증 & 인지신경과학(Cognitive Neuroscience) 연구에 기반하고 있습니다.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">하루 실행 기록 및 메타 데이터 모으기</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    저녁 시간 책상에 앉아 오늘 작성한 메모, 프로젝트 진행 내역을 훑어봅니다. 외부의 산만 요소를 철저히 차단하고, 뇌의 전두엽에 명확한 실행 목표와 프레임을 확립하는 데 온전히 집중합니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">5줄 요약 핵심 메타인지 일지 작성</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    오늘 잘된 점 2가지, 막혔던 점 1가지, 내일의 수정 행동 2가지를 5줄로 명확히 적습니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">내일의 핵심 미션 선명화</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    복기를 마친 후 내일 아침 제일 먼저 수행할 단 하나의 중요 과제를 적고 일지장을 덮습니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">반드시 5개 국어나 외국어로 써야 하나요?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">매일 일지를 쓰다가 지치면 어떻게 해야 하나요?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      장문의 글 대신 3개의 핵심 키워드만 적는 '키워드 복기'로 분량을 최소화하여 부담을 줄이세요.
    </p>
  </details>
</div>
