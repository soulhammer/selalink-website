...
오늘 BuildSelf에서는 마이클 펠프스가 실천했던 '초인지 사전 준비 루틴'의 작동 원리와 현대인들이 중대한 실전, 중요한 프레젠테이션, 또는 큰 긴장을 동반하는 업무를 시작하기 전 불안과 스트레스를 완전히 잠재울 수 있는 3단계 실천 루틴을 소개합니다.
...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      본 콘텐츠는 마이클 펠프스의 저서 <strong>&lt;No Limits&gt;</strong> 및 코치 밥 보우먼의 공식 회고록 내용과 스포츠 시합 직전의 정형화된 루틴 수행이 뇌의 긴장 수준에 미치는 국제스포츠심리학회지(IJSP)의 뇌파 분석 실증 연구를 기반으로 작성되었습니다.
    </p>
  </div>
</div>
...
또한 음악 감상이나 정형화된 동작 수행은 전두엽의 인지 자원을 '사소하고 단순한 작업'으로 미리 소모시켜, 발생하지 않은 미래의 실수에 대한 불필요한 부정적 시나리오 연상(불안증)을 강제 차단하는 똑똑한 우회 전략으로도 기능합니다.

---

## 2. 현대인을 위한 3단계 실천 루틴

실전에서의 흔들림 없는 평정심과 최상의 집중 능력을 획득하기 위한 펠프스식 3단계 마인드 컨트롤 루틴을 제안합니다.
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-indigo-500 bg-indigo-500/5 dark:bg-indigo-500/10 flex items-start gap-4">
  ...
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">인내와 일관성이 핵심입니다</strong>
