...
steps:
  - name: "디지털 자극과의 단절"
    text: "스마트폰을 주머니에 넣거나 비행기 모드로 설정합니다. 화면을 보며 걷는 행위는 뇌가 깊은 사색과 넓은 인지 상태로 진입하는 것을 방해합니다."
  - name: "일정한 속도로 15분간 자연 산책"
    text: "조용한 길이나 인근 공원을 찾아 일정한 보폭과 속도로 15분간 걷습니다. 발걸음과 주위 풍경, 호흡에 집중하여 뇌를 평온한 상태로 이끕니다."
  - name: "핵심 질문 던지기 및 내면의 문답"
    text: "오늘 해결해야 할 한 가지 핵심 질문을 설정합니다. 걸으면서 '왜?'라는 질문을 스스로에게 던지고 답하는 자문자답 과정을 반복하여 뜻밖의 통찰을 이끌어냅니다."
faqs:
  - question: "실내 러닝머신에서 걷는 것도 동일한 효과가 있나요?"
    answer: "유산소 혈류 증가 효과는 유사하나, 실외 자연을 시각적으로 탐색하며 얻는 시공간 감각 자극과 전두엽 스트레스 호르몬(코르티솔) 저하 효과는 야외 공원이나 자연 속을 걸을 때 극대화됩니다."
---

서양 철학의 기틀을 정립하고 끊임없이 스스로의 무지를 성찰하게 만든 고대 그리스 아테네의 현자 소크라테스(Socrates, B.C. 470 ~ B.C. 399). 그에 대해 남겨진 플라톤과 크세노폰의 수많은 기록 속에는 그가 가졌던 매우 독특한 일상 습관이 묘사됩니다. 👣

그것은 바로 언제나 광장이나 숲길을 하염없이 걸으며 주변 사람들과 쉴 새 없이 자문자답하고 질문을 던지며 토론하는 것이었습니다. 소크라테스는 실내 서재나 책상 앞에 앉아 깊은 사색에 빠진 인물이 아니었습니다. 그는 한여름에도, 추운 겨울에도 맨발로 아테네 중심지 아고라 광장이나 아카데메이아의 푸른 나무 그늘 아래를 천천히 걸었습니다. 그에게 산책길은 단순한 운동이 아닌, 육체의 운동감각과 발바닥이 전하는 진동을 뇌의 사고 가소성과 정밀하게 동기화시키는 지혜의 실험실이었습니다. 그는 걸을 때 인간의 뇌가 가장 창의적으로 작동하고, 낡은 편견을 깨뜨리는 고차원적인 질문을 떠올릴 수 있다는 생리학적 원리를 본능적으로 이해하고 있었습니다.
...
<div class="my-8 p-6 md:p-7 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-r from-indigo-500/10 via-indigo-500/5 to-transparent dark:border-indigo-500/30 dark:from-indigo-950/30 dark:to-slate-900/40 flex items-start sm:items-center gap-4 shadow-xs backdrop-blur-md">
  ...
  <div class="flex-1 min-w-0">
    ...
    <p class="text-xs md:text-sm text-indigo-800/90 dark:text-indigo-300/90 font-medium m-0 mt-1.5 leading-relaxed break-words">
      본 콘텐츠는 소크라테스 역사적 평전 및 자서전 기록 고증 & 인지신경과학(Cognitive Neuroscience) 연구에 기반하고 있습니다.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">디지털 자극과의 단절</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    스마트폰을 주머니에 넣거나 비행기 모드로 설정합니다. 화면을 보며 걷는 행위는 뇌가 깊은 사색과 넓은 인지 상태로 진입하는 것을 방해합니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">일정한 속도로 15분간 자연 산책</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    조용한 길이나 인근 공원을 찾아 일정한 보폭과 속도로 15분간 걷습니다. 발걸음과 주위 풍경, 호흡에 집중하여 뇌를 평온한 상태로 이끕니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">핵심 질문 던지기 및 내면의 문답</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">실내 러닝머신에서 걷는 것도 동일한 효과가 있나요?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      유산소 혈류 증가 효과는 유사하나, 실외 자연을 시각적으로 탐색하며 얻는 시공간 감각 자극과 전두엽 스트레스 호르몬(코르티솔) 저하 효과는 야외 공원이나 자연 속을 걸을 때 극대화됩니다.
    </p>
  </details>
</div>
