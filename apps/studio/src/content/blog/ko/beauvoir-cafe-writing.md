...
steps:
  ...
  - name: "몰입 전용 시작 스크립트 작성"
    text: "카페 단골 자리에 앉아 특정 음료(예: 루이보스 티 또는 아메리카노)를 주문해 두고 노트를 펼치는 일련의 행동 시퀀스를 기계화하여 뇌가 몰입 상태로 넘어가게 유도합니다."
  - name: "3시간 몰입 수행 및 소음 대피책 준비"
    text: "설정해 둔 시간(최소 3시간) 동안 몰입해 작업하며, 만약 주변 소음 데시벨이 너무 올라가거나 불쾌한 소음이 침범할 경우 바로 에어팟의 노이즈 캔슬링을 기동하여 인지적 안전을 확보합니다."
faqs:
  - question: "시몬 드 보부아르는 왜 카페 드 플로르를 선택했나요?"
...
보부아르는 매일 아침 10시가 되면 파리의 유명한 예술적 단골 카페인 '카페 드 플로르(Café de Flore)'로 출근했습니다. 그녀는 언제나 늘 앉는 조용한 구석 자리에 앉아 찻잔을 주문한 뒤, 오후 2시까지 꼬박 4시간 동안 미동도 없이 집필에 몰입했습니다. 카페 직원들은 그녀의 집필 흐름을 해치지 않기 위해 불필요한 서빙을 자제했고, 주변의 소음들은 오히려 그녀의 고독감과 잡생각을 지워주는 훌륭한 백색 소음 차단기 역할을 했습니다. 보부아르에게 카페는 방해받는 공간이 아닌, 삶의 모든 번잡함으로부터 자신을 완벽하게 단순화하여 격리하는 성역이었습니다.

오늘 BuildSelf에서는 시몬 드 보부아르의 '카페 집필' 루틴에 담긴 뇌 과학적 집중 작동 원리와, 끊임없는 잡념과 주의 산만에 시달리는 현대인을 위한 '나만의 몰입 작업 구역(Focus Zone)' 설정 방법을 알아봅니다.
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    음악 소리가 너무 크지 않고 자연스러운 대화 소리가 나지막하게 깔리는, 일하기 좋은 높이의 테이블을 구비한 집이나 직장 근처 카페 2곳을 미리 점찍어 둡니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    카페 단골 자리에 앉아 특정 음료(예: 루이보스 티 또는 아메리카노)를 주문해 두고 노트를 펼치는 일련의 행동 시퀀스를 기계화하여 뇌가 몰입 상태로 넘어가게 유도합니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    설정해 둔 시간(최소 3시간) 동안 몰입해 작업하며, 만약 주변 소음 데시벨이 너무 올라가거나 불쾌한 소음이 침범할 경우 바로 에어팟의 노이즈 캔슬링을 기동하여 인지적 안전을 확보합니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer">
    ...
    <p class="mt-3 text-sm text-slate-650 dark:text-slate-300 leading-relaxed pl-1">
      물론입니다. 꼭 집 밖으로 나가지 않더라도 집안의 특정 책상 구석에 특정 조명을 켜두거나, 몰입 시에만 마시는 머그컵을 지정하고 특정 배경 백색 소음을 켜두는 시퀀스만으로도 동일한 인지 스위칭 효과가 작동합니다.
    </p>
  </details>
</div>