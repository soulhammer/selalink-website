...
app: "buildself"
formatVersion: 4
authority: "마르쿠스 아우렐리우스 《자성록》 및 역사적 평전 고증 & 인지신경과학(Cognitive Neuroscience) 연구"
steps:
  - name: "고요한 아침 환경 확보하기"
    text: "본격적인 하루의 소음과 디지털 기기의 알림이 켜지기 전, 가장 고요한 아침 시간대를 확보합니다. 은은한 조명 아래서 컴퓨터나 전자기기 대신 종이 노트를 펼쳐 자리에 앉습니다."
  - name: "오늘 마주할 마찰 예상하기"
    text: "오늘 하루 동안 마주할 수 있는 마찰 요소(예: 껄끄러운 회의, 예기치 않은 지연)를 미리 적습니다. 타인의 태도는 통제 불가능하지만, 본인의 대처 태도는 스스로 완벽하게 조율할 수 있음을 상기합니다."
  - name: "자제심을 위한 행동 다짐 적기"
...
로마 제국의 제16대 황제이자 '현군(賢君)'으로 칭송받는 5현제 시대의 마지막 군주, 스토아 철학자 마르쿠스 아우렐리우스(Marcus Aurelius, 121–180). 그는 다뉴브강 전선의 마르코만니 전쟁과 제국 전체를 덮친 안토니누스 역병(Antonine Plague)이라는 참혹한 위기 속에서도 결코 평정심을 잃지 않았습니다. 밤낮으로 전쟁터의 야전 텐트에서 제국의 사명을 짊어져야 했던 그가 후세에 철학적 명작으로 남은 《자성록(Ta Eis Heauton)》을 써 내려간 시간은 바로 일출 직전 새벽녘의 고요 속이었습니다. 그는 누군가에게 보여주기 위해서가 아니라, 오직 스스로의 영혼을 다스리고 평정심을 유지하기 위해 펜을 들었습니다.
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">고요한 아침 환경 확보하기</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    본격적인 하루의 소음과 디지털 기기의 알림이 켜지기 전, 가장 고요한 아침 시간대를 확보합니다. 은은한 조명 아래서 컴퓨터나 전자기기 대신 종이 노트를 펼쳐 자리에 앉습니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">오늘 마주할 마찰 예상하기</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
