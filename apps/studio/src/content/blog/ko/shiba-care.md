...
steps:
  - name: "시바견의 바디 랭귀지: 부담감과 긴장의 신호"
    text: "시바견은 자신의 공간이 침해받을 때 조용히 거부 의사를 표시합니다. 대표적인 행동은 '고개 돌리기'와 '몸 털기'입니다. 사람이 손을 뻗어 만지려 할 때 머리를 피하거나 고개를 돌리는 것은 절대 튕기는 것이 아니라, '지금은 만지지 말아주세요'라는 완곡한 거절입니다. 또한 스트레스 상황이 끝나고 몸을 파르르 크게 터는 행동은 몸에 쌓인 불안과 에너지를 털어내 스스로를 리셋하려는 본능적인 대처 행동입니다."
  - name: "시바견 (Shiba Inu)의 몸짓 언어와 바디 시그널"
    text: "* 고개 돌리기 (Looking Away): 상대방의 접근이 부담스러우니 멈춰달라는 정중한 요청입니다. (이 신호를 보이면 억지로 만지지 말고 손을 치워 공간을 허용해 주십시오.)

* 몸 털기 (Shake Off): 방금 전의 상황에서 받았던 스트레스나 물리적 긴장감을 해소하려는 행동입니다. (빗질 등 싫어하는 활동 도중 몸을 털면, 긴장 해소 신호이므로 즉시 멈추고 쉬게 하십시오.)"
  - name: "시바견 (Shiba Inu) 맞춤형 3단계 홈케어 루틴"
    text: "* STEP 1. 아침: 민감 부위 터치 둔감화 교육: 시바견이 만지기 싫어하는 발목이나 엉덩이를 1초 살짝 만지고 바로 좋아하는 간식을 주는 루틴을 반복하여 접촉에 대한 긍정적인 인식을 만듭니다.

* STEP 2. 오후: 거부감 없는 이중모 전용 브러싱: 빽빽한 이중모 속 죽은 털을 제거할 때, 슬리커 빗을 사용해 피모 결 방향으로 가볍게 빗겨주고 시바견이 으르렁대거나 물려는 낌새를 보이면 즉시 중단합니다.

* STEP 3. 저녁: 독립적 공간(하우스/켄넬) 존중: 저녁 휴식 시 시바견이 켄넬이나 전용 방석 등 자기만의 숨은 영역에 들어갔을 때는 억지로 꺼내거나 만지지 말고 혼자서 완전히 쉴 수 있게 내버려 둡니다."
faqs:
  - question: "시바견이 빗질할 때 소리를 지르고 비명을 지르는데 어떻게 해야 하나요?"
    answer: "이른바 '시바 스크림(Shiba Scream)'입니다. 엄살이나 단순 거부가 아니라 실제 큰 부담과 두려움을 느낄 때 나타납니다. 빗질을 즉시 멈추고 빗을 갖다 대기만 해도 맛있는 간식을 주는 단계부터 둔감화 교육을 다시 시작해야 합니다."
  - question: "시바견은 왜 다른 개들처럼 꼬리를 치며 살갑게 굴지 않나요?"
...
<div class="my-8 p-6 md:p-7 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-r from-emerald-500/10 via-emerald-500/5 to-transparent dark:border-emerald-500/30 dark:from-emerald-950/30 dark:to-slate-900/40 flex items-start sm:items-center gap-4 shadow-xs backdrop-blur-md">
  ...
  <div class="flex-1 min-w-0">
    ...
    <p class="text-xs md:text-sm text-emerald-800/90 dark:text-emerald-300/90 font-medium m-0 mt-1.5 leading-relaxed break-words">
      본 콘텐츠는 National Shiba Club of America 및 IAABC 행동 치료 가이드라인에 기반하고 있습니다.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">시바견의 바디 랭귀지: 부담감과 긴장의 신호</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    시바견은 자신의 공간이 침해받을 때 조용히 거부 의사를 표시합니다. 대표적인 행동은 '고개 돌리기'와 '몸 털기'입니다. 사람이 손을 뻗어 만지려 할 때 머리를 피하거나 고개를 돌리는 것은 절대 튕기는 것이 아니라, '지금은 만지지 말아주세요'라는 완곡한 거절입니다. 또한 스트레스 상황이 끝나고 몸을 파르르 크게 터는 행동은 몸에 쌓인 불안과 에너지를 털어내 스스로를 리셋하려는 본능적인 대처 행동입니다.
  </p>
</div>

---

## 2. 시바견 (Shiba Inu)의 몸짓 언어와 바디 시그널
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">고개 돌리기 (Looking Away)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        상대방의 접근이 부담스러우니 멈춰달라는 정중한 요청입니다.
      </p>
    </div>
    <div class="p-4 md:p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-950/30">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        이 신호를 보이면 억지로 만지지 말고 손을 치워 공간을 허용해 주십시오.
      </p>
    </div>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.04] to-transparent dark:border-emerald-500/20 dark:bg-emerald-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-5">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">몸 털기 (Shake Off)</h4>
  </div>
  <div class="grid grid-cols-1 gap-4">
    <div class="p-4 md:p-5 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 dark:bg-emerald-950/30">
      <div class="flex items-center gap-2 mb-2">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        방금 전의 상황에서 받았던 스트레스나 물리적 긴장감을 해소하려는 행동입니다.
      </p>
    </div>
    <div class="p-4 md:p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-950/30">
      <div class="flex items-center gap-2 mb-2">
      ...
      <p class="text-slate-800 dark:text-slate-200 text-sm md:text-base leading-relaxed m-0 font-normal">
        빗질 등 싫어하는 활동 도중 몸을 털면, 긴장 해소 신호이므로 즉시 멈추고 쉬게 하십시오.
      </p>
    </div>
  </div>
</div>
...
## 3. 시바견 (Shiba Inu) 맞춤형 3단계 홈케어 루틴

<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    <span class="px-3.5 py-1.5 text-xs font-black tracking-wider bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300 rounded-full border border-indigo-500/30 shadow-xs">ROUTINE 1</span>
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">아침: 민감 부위 터치 둔감화 교육</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    시바견이 만지기 싫어하는 발목이나 엉덩이를 1초 살짝 만지고 바로 좋아하는 간식을 주는 루틴을 반복하여 접촉에 대한 긍정적인 인식을 만듭니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">오후: 거부감 없는 이중모 전용 브러싱</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    빽빽한 이중모 속 죽은 털을 제거할 때, 슬리커 빗을 사용해 피모 결 방향으로 가볍게 빗겨주고 시바견이 으르렁대거나 물려는 낌새를 보이면 즉시 중단합니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-indigo-500/20 bg-gradient-to-b from-indigo-500/[0.04] to-transparent dark:border-indigo-500/20 dark:bg-indigo-950/20 shadow-sm backdrop-blur-md">
  <div class="flex flex-wrap items-center gap-3 mb-4">
    ...
    <h4 class="text-lg md:text-xl font-extrabold text-slate-900 dark:text-slate-100 m-0">저녁: 독립적 공간(하우스/켄넬) 존중</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-200 leading-relaxed text-sm md:text-base m-0 font-normal">
    저녁 휴식 시 시바견이 켄넬이나 전용 방석 등 자기만의 숨은 영역에 들어갔을 때는 억지로 꺼내거나 만지지 말고 혼자서 완전히 쉴 수 있게 내버려 둡니다.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/60 dark:border-white/10 dark:bg-slate-900/40 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/80 dark:border-slate-800/80 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="true">
      <span class="pr-4">시바견이 빗질할 때 소리를 지르고 비명을 지르는데 어떻게 해야 하나요?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      이른바 '시바 스크림(Shiba Scream)'입니다. 엄살이나 단순 거부가 아니라 실제 큰 부담과 두려움을 느낄 때 나타납니다. 빗질을 즉시 멈추고 빗을 갖다 대기만 해도 맛있는 간식을 주는 단계부터 둔감화 교육을 다시 시작해야 합니다.
    </p>
  </details>

  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none text-base md:text-lg tracking-tight" role="button" aria-expanded="false">
      <span class="pr-4">시바견은 왜 다른 개들처럼 꼬리를 치며 살갑게 굴지 않나요?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400 dark:text-slate-500 flex-shrink-0">▼</span>
    </summary>
    <p class="mt-3 text-sm md:text-base text-slate-700 dark:text-slate-300 leading-relaxed pl-1 m-0 font-normal">
      성격이 고양이와 유사하여 과도한 터치나 환영 표현을 하지 않는 품종적 특성을 가지고 있습니다. 꼬리를 마구 흔들지 않더라도 보호자 근처에서 조용히 누워있거나 관찰하는 것만으로도 깊은 애정을 나타내고 있는 것입니다.
    </p>
  </details>
</div>
