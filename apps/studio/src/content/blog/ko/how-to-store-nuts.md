...
steps:
  ...
  - name: "불투명 밀폐 용기나 알루미늄 지퍼백에 소분 포장하기 — 빛과 산소 완벽 차단 📦"
    text: "자외선과 빛, 산소는 견과류 속 유지방의 산화를 촉진하는 주원인입니다. 💡 보관 팁: 투명한 용기보다는 빛을 차단하는 불투명 밀폐 용기나 알루미늄 지퍼백에 1회 먹을 분량씩 소분하여 담으세요. 이때 실리카겔(제습제)이나 산소흡수제를 함께 넣어주면 최적의 상태가 유지됩니다."
  - name: "습기가 없는 완전 건조 상태 유지하기 — 미개봉 실온 보관 (15일) ☀️"
    text: "견과류는 수분을 흡수하면 금세 눅눅해지고 아삭한 식감이 사라집니다. 💡 보관 팁: 개봉 전이더라도 습도가 높은 곳을 피해 서늘하고 건조한 그늘에 보관해야 합니다. 습기를 차단하는 밀폐력을 갖춘 포장 상태를 항상 유지하세요."
faqs:
  - question: "견과류에서 쩐내(기름 찌든 냄새)가 나는데 물로 씻거나 볶아서 먹어도 되나요?"
    answer: "절대 안 됩니다. 쩐내는 견과류의 불포화지방산이 산소와 결합해 산패되었음을 뜻하며, 이 과정에서 강력한 곰팡이독소인 '아플라톡신(Aflatoxin)'이 생성됩니다. 아플라톡신은 국제암연구소(IARC)가 지정한 1급 발암물질로 260℃ 이상의 고온으로 가열하거나 씻어도 절대 파괴되지 않으므로, 쩐내가 나는 즉시 전량 버려야 합니다."
  - question: "견과류를 상온 식탁이나 찬장에 두고 먹는 것이 안 좋은 이유는 무엇인가요?"
    answer: "견과류에 풍부한 불포화지방산은 열, 빛, 산소, 습도에 매우 민감합니다. 상온(15 ~ 25℃)에 투명 용기로 보관하면 빛과 온도 영향으로 단 며칠 만에 지방 산패가 시작되며 곰팡이가 번식하기 쉬운 상태가 됩니다. 밀폐하여 차갑고 어두운 냉장실이나 냉동실에 보관해야 안전합니다."
---
