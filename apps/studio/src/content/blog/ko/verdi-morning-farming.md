...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      본 콘텐츠는 베르디의 농장 기록과 생전 일기를 담은 메리 제인 필립스-매츠의 학술 연구서 『베르디 평전(Verdi: A Biography)』과 아침 야외 자연광 노출 및 대지 접촉(Grounding/Earthing)의 신경생리학적 이완 작용을 다룬 환경신경과학 임상 결과를 바탕으로 작성되었습니다.
    </p>
  </div>
</div>
...
## 1. 새벽 자연 노출과 자연 접촉(Earthing)의 신경 생리학
...
## 3. 고강도 피로 누적의 위험성과 경량 유산소 노동 지향
