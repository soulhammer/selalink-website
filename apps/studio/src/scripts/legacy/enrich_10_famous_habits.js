...
const enrichedHabits = [
  // 1. ramanujan-dream-notebook
  {
    ...
    intro: {
      ...
      en: "Srinivasa Ramanujan, the legendary Indian mathematical genius who published over 3,900 original theorems in number theory and infinite series, transforming modern mathematics. Where did his unprecedented intuitive inspiration come from? 📐\n\nRamanujan frequently experienced dreams where the Hindu goddess Namagiri presented complex mathematical formulas written in red ink on a screen. For Ramanujan, sleep was not merely physical rest, but a subconscious laboratory where unconstrained geometric ideas merged freely. Upon waking, while his brain remained in a hazy alpha wave state, he immediately sat up and wrote down every formula on his bedside slate and notebook before the vivid impressions evaporated.\n\nToday, BuildSelf explores the scientific mechanism behind Ramanujan's 'morning intuition note' routine and how modern creative thinkers can leverage it to solve complex problems.",
      ja: "数論と無限級数の分野で前人未到の3,900以上の公式を生み出し、現代数学に革命をもたらしたインドの天才数学者スリニヴァーサ・ラマヌジャン。正規の高等教育を受けずとも偉大な定理を残した彼のひらめきはどこから生まれたのでしょうか？ 📐\n\nラマヌジャンは睡眠中、ヒンドゥー教の女神ナマギリが赤いインクで複雑な数式を屏風のように見せてくれる夢を頻繁に見ました。彼にとって睡眠は潜在意識下でアイデアが自由に再結合する最高の研究所でした。目覚めた直後、脳がα波の状態にあるうちに、夢の中の数式を即座に枕元のノートに書き留めました。\n\n今日のBuildSelfでは、ラマヌジャンの「目覚め直後メモ」の科学的原理と実践法を紹介します。",
      zh: "在数论与无穷级数领域推导出3900多个独创公式、彻底改变现代数学范式的印度天才数学家斯里尼瓦瑟·拉马努金。他那惊人的直觉灵感究竟源自何处？ 📐\n\n拉马努金经常在梦中梦见女神向他展示用红墨水写就的复杂数学公式。对他而言，睡眠是潜意识中创意自由重组的实验室。醒来后在大脑处于α波状态的最初几分钟内，他会立即在床头笔记本上记下这些公式。\n\n今天，BuildSelf 将带您探究拉马努金“醒后直觉笔记”惯例的科学原理及实践指南。",
      es: "Srinivasa Ramanujan, el genio matemático indio que publicó más de 3,900 teoremas en teoría de números. ¿De dónde provenía su inspiración intuitiva? 📐\n\nRamanujan soñaba con fórmulas complejas presentadas en tinta roja por la diosa Namagiri. Al despertar, mientras su cerebro aún estaba en estado alfa, anotaba inmediatamente las ecuaciones en su libreta de noche.\n\nHoy, BuildSelf explora los principios científicos de la rutina de notas al despertar de Ramanujan y su aplicación moderna.",
      fr: "Srinivasa Ramanujan, le génie mathématique indien ayant publié plus de 3 900 théorèmes originaux. D'où lui venait son inspiration ? 📐\n\nRamanujan rêvait de formules complexes écrites à l'encre rouge. Dès le réveil, pendant que son cerveau était en ondes alpha, il notait immédiatement les équations.\n\nAujourd'hui, BuildSelf explore les principes scientifiques de la routine de notes au réveil de Ramanujan.",
      de: "Srinivasa Ramanujan, das indische mathematische Genie mit über 3.900 Theoremen. Woher stammte seine intuitive Inspiration? 📐\n\nRamanujan träumte oft von Formeln, die ihm in roter Tinte offenbart wurden. Gleich nach dem Aufwachen im Alpha-Zustand schrieb er die Gleichungen auf.\n\nHeute untersucht BuildSelf die wissenschaftlichen Prinzipien von Ramanujans Aufwach-Notizroutine.",
      pt: "Srinivasa Ramanujan, o gênio matemático indiano que publicou mais de 3.900 teoremas. De onde vinha sua inspiração intuitiva? 📐\n\nRamanujan frequentemente sonhava com fórmulas em tinta vermelha. Ao acordar, em estado alfa, ele anotava imediatamente as equações.\n\nHoje, o BuildSelf explora os princípios científicos da rotina de anotações ao acordar de Ramanujan.",
      id: "Srinivasa Ramanujan, genius matematika India yang mempublikasikan lebih dari 3.900 teorema. Dari mana datangnya inspirasi intuitifnya? 📐\n\nRamanujan sering bermimpi tentang formula yang ditulis dengan tinta merah. Saat bangun tidur dalam kondisi gelombang alfa, ia segera mencatat persamaan tersebut.\n\nHari ini, BuildSelf menjelajahi prinsip ilmiah di balik rutinitas catatan pagi Ramanujan."
    },
    whyTitle: {
    ...
    whyDesc: {
      ko: "우리가 잠에서 깨어난 직후 첫 5~10분 동안 인간의 뇌는 전두엽의 비판적 논리가 활성화되기 전, 의식과 무의식의 경계인 **알파파(Alpha Waves)** 및 느린 세타파 상태에 유연하게 머뭅니다. 이 시간 동안 뇌의 **기본 모드 네트워크(Default Mode Network, DMN)**가 밤새 잠재의식 속에서 재조합한 기발한 연상 결합들이 휘발되지 않고 의식의 표면으로 부드럽게 떠오릅니다.\n\n대부분의 현대인들은 눈을 뜨자마자 스마트폰 알림이나 이메일을 확인하여 뇌를 자극적인 **베타파(Beta Waves)** 상태로 강제 전환시킵니다. 하지만 라마누잔처럼 기상 직후 폰을 보지 않고 찰나의 직관을 종이에 기록하면, 논리적 자아가 아이디어를 미리 검열하거나 억제하지 않아 잠재의식이 선사한 무한한 창의적 아이디어를 100% 보존할 수 있습니다.",
      en: "For 5 to 10 minutes immediately after waking up, before critical prefrontal logic takes over, the brain remains in a fluid **Alpha Wave** state between consciousness and subconsciousness. During this window, innovative associative connections synthesized overnight by the **Default Mode Network (DMN)** float gently into conscious awareness.\n\nWhile most modern individuals immediately check phone notifications, forcing their brains into high-stress **Beta Waves**, capturing fleeting intuitions upon waking without digital distraction—like Ramanujan—preserves 100% of subconscious creative insights before logical pre-censorship occurs.",
      ja: "目覚めた直後の5〜10分間、前頭葉の批判的論理が働く前に、脳は**α波状態**にあります。この間に**デフォルト・モード・ネットワーク（DMN）**が潜在意識下で再結合したアイデアが浮上します。\n\nスマホを見ずに直感を記録することで、論理的自我による検閲を受けずに創造的アイデアを100%保護できます。",
      zh: "醒来后的5-10分钟内，在大脑前额叶逻辑全面主导前，处于**α波状态**。此时由**默认模式网络(DMN)**在潜意识中重组的灵感会浮现出来。\n\n在醒来后立即记录直觉而不看手机，可以避免逻辑自我过早审查，从而百分之百地保留创意。",
      es: "Durante 5-10 minutos tras despertar, el cerebro permanece en estado de **ondas alfa**. Las combinaciones creativas de la **Red por Defecto (DMN)** emergen.\n\nAl registrar la intuición al despertar sin mirar el teléfono, preservas las ideas creativas al 100% sin censura previa.",
      fr: "Pendant 5 à 10 minutes après le réveil, le cerveau reste en **ondes alpha**. Les combinaisons du **Réseau par Défaut (DMN)** émergent.\n\nEn notant l'intuition dès le réveil sans regarder son téléphone, on préserve 100% des idées créatives.",
      de: "5-10 Minuten nach dem Aufwachen befindet sich das Gehirn im **Alpha-Zustand**. Kombinationen des **Default-Mode-Netzwerks (DMN)** steigen auf.\n\nIndem man Intuitionen sofort aufschreibt, bewahrt man kreative Ideen zu 100%.",
      pt: "Durante 5 a 10 minutos após acordar, o cérebro permanece em **ondas alfa**. As combinações da **Rede de Modo Padrão (DMN)** emergem.\n\nAo registrar a intuição ao acordar sem olhar para o celular, você preserva as ideias criativas a 100%.",
      id: "Selama 5-10 menit setelah bangun, otak berada dalam **gelombang alfa**. Kombinasi dari **Default Mode Network (DMN)** muncul.\n\nDengan mencatat intuisi saat bangun tanpa melihat ponsel, Anda mempertahankan ide kreatif 100%."
    },
    steps: [
      {
        name: {
      ...
      },
      {
        ...
        text: {
          ...
          zh: "切勿在早晨立即评估原始笔记，待下午理性大脑活跃时，再重新审视并梳理出可行步聚。",
...
function runEnrich() {
  enrichedHabits.forEach(item => {
    ...
    console.log(`[풍성 보강] 번역 JSON: ${item.slug}.json`);
...
`;
    ...
    console.log(`[풍성 보강] KO 마크다운: ${item.slug}.md`);
  });
}
