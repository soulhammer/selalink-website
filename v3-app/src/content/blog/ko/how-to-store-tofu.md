...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    아무리 소금을 넣었더라도 물이 고여있으면 단백질 분해균이 자라납니다. 번거롭더라도 하루에 한 번 깨끗한 물로 갈아주는 것이 두부 신선도를 최고로 유지하는 과학적 방법입니다.
  </p>
</div>
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-amber-500 bg-amber-500/5 dark:bg-amber-500/10 flex items-start gap-4">
  <span class="text-xl">⚠️</span>
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">표면의 미끈거림을 확인하세요 ⚠️</strong>
    <p class="text-slate-700 dark:text-slate-300 text-sm m-0 leading-relaxed">
      꺼낸 두부 표면이 미끈거리고 미끈한 흰 점액질이 보인다면 단백질 부패가 한참 진행된 상태이므로 식중독 예방을 위해 절대 먹지 말고 전량 폐기해야 합니다.
    </p>
  </div>
</div>
