...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      Ce contenu est basé sur la biographie <strong>&lt;Einstein: A Life&gt;</strong> et sur des recherches en sciences cognitives (Frontiers in Psychology) concernant les effets positifs de la pratique d'un instrument sur la créativité cognitive et la connectivité cérébrale.
    </p>
  </div>
</div>
...
## 2. Routine de Réinitialisation en 3 Étapes pour les Modernes

Face à une impasse, nous vous proposons une routine moderne pour réinitialiser votre cerveau et trouver une issue, à la manière d'Einstein.
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-indigo-500 bg-indigo-500/5 dark:bg-indigo-500/10 flex items-start gap-4">
  ...
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">Il faut savoir lâcher prise pour voir naître les idées</strong>
