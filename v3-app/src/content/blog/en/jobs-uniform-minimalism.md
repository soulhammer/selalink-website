...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      This content is based on the official biography <strong>&lt;Steve Jobs&gt;</strong> by Walter Isaacson and research published in the Journal of Personality and Social Psychology (JPSP) proving the Ego Depletion theory that the accumulation of minor choices decreases decision quality.
    </p>
  </div>
</div>
...
## 1. Preserving Brain Judgment Energy: Preventing 'Decision Fatigue'

According to brain science and behavioral economics, the total amount of daily decision-making energy a human has is very limited. If you repeat minor choices like checking your smartphone, choosing clothes, and choosing breakfast from the start of the day, the brain's cognitive battery is depleted before important work even starts. This is called 'Decision Fatigue.'
...
## 2. 3-Step Jobs Decision Simplification Routine for Modern People

To clean your mind in the morning and make the best decisions in business or important studies, we propose a modern Jobs simplification routine.
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Every evening before going to bed or on Sunday night, place your clothes, socks, bags, and items to bring (wallet, car keys, etc.) in a visible place. Cut off all minor worries and search behaviors in the morning.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    You do not need to wear the exact same uniform like Steve Jobs, but establish 2-3 core templates of clothes that feel most comfortable and give a good impression (e.g., shirt and slacks, white t-shirt and beige pants). This prevents wasting time on fashion choices in the morning.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Confirm your 9 AM brain energy preserved thanks to simplified morning preparations. Instead of replying to emails or holding minor meetings, process high-cognitive tasks first, such as reviewing critical proposals or solving complex problems.
  </p>
</div>
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-indigo-500 bg-indigo-500/5 dark:bg-indigo-500/10 flex items-start gap-4">
  ...
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">Lessen the load to lessen fatigue and focus more</strong>
    <p class="text-slate-700 dark:text-slate-300 text-sm m-0 leading-relaxed">
      For Steve Jobs, the black turtleneck was more than just a piece of clothing; it was a smart tool. By stripping away minor choices, he could converge all his cognitive abilities onto the creative world and Apple's essence that he loved. Start simplifying decision processes one by one in your daily life. Your choices will become much lighter and smarter.
    </p>
  </div>
</div>
