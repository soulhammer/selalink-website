...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      Este conteúdo baseia-se nos registros pessoais de Thomas Edison <strong>&lt;The Diary and Sundry Observations of Thomas Alva Edison&gt;</strong> e em estudos sobre a melhoria da resolução criativa de problemas no estado hipnagógico publicados na revista 'Science Advances' pelo Instituto do Cérebro de Paris em 2021.
    </p>
  </div>
</div>
...
## 1. O momento de ouro da criatividade quando o cérebro se liberta

Edison estava convencido de que o cérebro realiza suas associações analógicas mais livres e ilimitadas no estado de transição entre o estar acordado e o dormir, a chamada fase hipnagógica.
...
## 2. A rotina da soneca da chave de Edison em 3 passos para o dia a dia

Propomos um método de soneca de 10 minutos inspirado em Edison para reativar o cérebro quando se deparar com bloqueios criativos.
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Segure um chaveiro de metal pesado ou uma garrafa térmica de metal fácil de segurar e que faça barulho ao cair. Sentado em uma cadeira, posicione uma bandeja de metal sob sua mão.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Recoste-se profundamente na poltrona, feche os olhos e relaxe o corpo. Pense de forma muito leve sobre o problema que deseja resolver e deixe-se levar pelo sono.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Quando os músculos da mão relaxarem e o objeto cair fazendo barulho, não hesite: escreva imediatamente todas as palavras, imagens e fragmentos de pensamentos em um caderno ou bloco de notas do celular.
  </p>
</div>

---

## 3. 💡 O segredo está em acordar antes de entrar em sono profundo é o segredo

<div class="my-6 p-5 rounded-2xl border-l-4 border-indigo-500 bg-indigo-500/5 dark:bg-indigo-500/10 flex items-start gap-4">
  <span class="text-xl">💡</span>
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">Acordar antes de entrar em sono profundo é o segredo</strong>
    <p class="text-slate-700 dark:text-slate-300 text-sm m-0 leading-relaxed">
      O propósito desta rotina não é descansar, mas obter apenas a energia criativa da fase hipnagógica, onde o filtro de controle do cérebro é atenuado. O estímulo da queda da bola ou da chave é um despertador analógico muito inteligente que impede que caiamos no sono profundo, fase em que as ondas cerebrais desaceleram e as inspirações são esquecidas.
    </p>
  </div>
</div>
