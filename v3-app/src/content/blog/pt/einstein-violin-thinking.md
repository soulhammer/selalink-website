...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    <h5 class="text-sm font-bold text-indigo-800 dark:text-indigo-300 m-0">
      Fundamentação Histórica e Acadêmica
    </h5>
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      Este conteúdo baseia-se na biografia <strong>&lt;Einstein: A Life&gt;</strong> e em pesquisas de ciência cognitiva (Frontiers in Psychology) sobre os efeitos positivos de tocar instrumentos musicais na capacidade de processamento cognitivo criativo e na conectividade cerebral.
    </p>
  </div>
</div>
...
## 2. Rotina de Reinício de Einstein em 3 Passos para Pessoas Modernas

Quando você estiver em um beco sem saída, propomos uma rotina prática moderna para reiniciar seu cérebro e encontrar um novo caminho, assim como Einstein.
...
## 3. Um Conselho da Neurociência para uma Rotina Eficiente

<div class="my-6 p-5 rounded-2xl border-l-4 border-indigo-500 bg-indigo-500/5 dark:bg-indigo-500/10 flex items-start gap-4">
  <span class="text-xl">💡</span>
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">É preciso saber desapegar para enxergar novas ideias</strong>
