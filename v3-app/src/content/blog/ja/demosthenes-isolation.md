...
app: "buildself"
authority: "プルタルコス英雄伝『デ모ステネス伝』および米国心理学会（APA）の環境管理研究"
---
...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      本コンテンツは、プルタルコスが著した歴史書<strong>『英雄伝：デモステネス伝』</strong>および米国心理学会（APA）に掲載された刺激統制理論（Stimulus Control Theory）と意志力枯渇防止行動研究を基に作成されました。
    </p>
  </div>
</div>
...
## 1. 意志力を信じるな、誘惑のない環境を設計せよ

デモステネスは、人間の弱い意志力は信用に値するものではなく、行動を強制する物理的な環境を構築して初めて、完全な没頭が可能になると考えました。
...
## 2. 現代人のためのデモステネス隔離ルーティン3段階

意志力を削り取る最大の誘惑である、現代の「デジタルスマートフォン」に打ち勝つための現代版デモステネス没頭ルーティンを提案します。
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    重要な勉強や業務を始める直前、スマートフォンの電源を切るか、完全マナーモード（バイブレーションなし）に設定します。その後、今作業しているデスクの上ではなく、別の部屋や引き出しの奥深くに入れ、目に入らない場所に片付けます。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    デスクの上には、今すぐ処理すべき唯一の資料だけを置きます。その後、アナログタイマーなどを活用して25分または50分の集中時間を設定し、その時間内はただ一つの業務だけに集中します。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    集中セッションが終了したら、スマートフォンをチェックする代わりに、席に座って目を閉じ、深呼吸をしたり軽いお水を一杯飲んだりして脳に短い休息を与えます。脳が情報を正しく処理できるオフライン状態を維持します。
  </p>
</div>
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-indigo-500 bg-indigo-500/5 dark:bg-indigo-500/10 flex items-start gap-4">
  ...
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">目の前の誘惑を耐えるだけで脳はすでに疲労しています</strong>
    <p class="text-slate-700 dark:text-slate-300 text-sm m-0 leading-relaxed">
      スマートフォンがデスクの上にあるだけでも、私たちの脳は「スマートフォンを見たい」という無意識の誘惑を抑えるためにエネルギーを消耗しています。誘惑が最初から目に入らないように物理的に隔離することは、不要な意志力の消耗を遮断し、脳のすべてのリソースを高度な認知的・創造的業務だけに集中させるための科学的な必勝法です。
    </p>
  </div>
</div>
