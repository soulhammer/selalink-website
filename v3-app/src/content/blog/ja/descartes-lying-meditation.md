...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      本コンテンツは、アドリアン・バイエが著した初のデカルト伝記<strong>「La Vie de Monsieur Descartes」</strong>および、起床直後の水平姿勢が自律神経系の安定と創造的（アルファ波）の形成に及ぼす影響に関する精神生理学（Psychophysiology）の研究を基に作成されました。
    </p>
  </div>
</div>
...
## 1. 朝5分の「横たわり」が1日の安定を決める

多くの現代人は、朝アラームの音に驚いて心臓がドキドキした状態で急いで起き、スマートフォンのメールやメッセージを確認して1日を始めます。これは1日の始まりから、ストレスホルモンであるコルチゾールやアドレナリンの分泌を誘導し、覚醒レベルを過度に高め、1日中焦燥感や慢性的な疲労感を感じる原因になります。
...
## 2. 現代人のためのデカルト5分ベッド瞑想3ステップ

目が覚めた瞬間から始まる忙しい日常の中で、脳に余裕を与え、最高の精神状態を引き出す現代的なデカルトルーティンを提案します。
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    朝のアラームを切った後、すぐにベッドから起き上がったり、スマートフォンの画面を点灯してネット検索や通知を確認したりしないでください。身体を完全に布団の中に横たえた状態のままにし、スマートフォンは遠ざけておきます。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    目を穏やかに閉じるか、天井をじっと見つめ、鼻から深く息を吸い、口からゆっくり吐き出す呼吸を5回繰り返します。吸う時に頭がすっきりし、吐く時に肩や首、腰の緊張が抜けていくのを静かに観察します。
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    今日やるべき多くのことを焦って計算するのではなく、ただ一つ「今日、自分が最も集中して解決したい価値は何か？」を自分に問いかけます。落ち着いた頭の中にその目標を一つのイメージや言葉として鮮明に浮かべ、1分間平穏を味わった後、ベッドから静かに起き上がります。
  </p>
</div>
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-indigo-500 bg-indigo-500/5 dark:bg-indigo-500/10 flex items-start gap-4">
  ...
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">ゆっくりとしたスタートが1日の速度をコントロールする</strong>
    <p class="text-slate-700 dark:text-slate-300 text-sm m-0 leading-relaxed">
      デカルトにとって、ベッドは決して怠惰の象徴ではありませんでした。むしろ、彼の脳が現実の細かな騒音から逃れ、数学や哲学という宇宙の本質を明晰に描くことができる、最も静かで完璧な時空間でした。1日わずか5分でも、目を開けた朝のベッドの上で、脳に真のリラックスの機会を与えてください。
    </p>
  </div>
</div>
