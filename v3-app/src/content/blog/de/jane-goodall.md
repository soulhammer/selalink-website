---
title: "Jane Goodalls Absorptionsgewohnheiten wurden ihr ganzes Leben lang beobachtet und aufgezeichnet, als sie auf einem Felsen neben einem Schimpansen saß."
description: "Als Verhaltensforscher, der mit Schimpansen im Wald von Gombe, Afrika, lebte, erreichte er wissenschaftliche Überlegungen durch Training, um Urteile völlig auszuschließen und das Ziel anzustarren."
pubDate: "2026-05-09"
updatedDate: "2026-05-09"
category: "BuildSelf"
tags: ["Jane Gooda","Routine"]
...
steps:
  - name: "Schritt 1: Umgebungseinstellungen und Werkzeugeinstellungen"
    text: "Wählen Sie sorgfältig ein triviales Objekt aus, an dem Sie jeden Nachmittag oder auf dem Weg zur Arbeit häufig in der Umgebung vorbeikommen (z. B. die Blätter eines Straßenbaums, die sich im Wind wiegen, die Rundung einer Tasse in einem Café usw.). Lassen Sie Ihr Smartphone stumm schalten."
  - name: "Schritt 2: Projektion und Übung aller Sinne"
    text: "Schauen Sie zwei Minuten lang ruhig und mit hoher Konzentration auf die aktuelle Form des ausgewählten Objekts, das unregelmäßige Licht und die Schattierung der Textur und die feine Dehnungsstruktur der Blattadern, als würden Sie durch eine Lupe schauen."
  - name: "Schritt 3: Objektiver Blick und Metaorganisation"
    text: "Die drei mikroskopischen physikalischen Eigenschaften des Objekts, die durch Beobachtung erkannt werden, werden klar in einer visuellen Informationskarte zusammengefasst, als ob sie ein Bild im Kopf machen würden, und im Notizbuch des Geistes gespeichert."
faqs:
  - question: "Kann ich ein Smartphone-Foto von etwas machen, das ich mit meinen Augen beobachte, und es analysieren?"
    answer: "Nein. Bilder auf digitalen Bildschirmen sind lediglich komprimierte 2D-Pixel und aktivieren nicht das stereoskopische Wahrnehmungsneuronale Netzwerk des Gehirns. Sie müssen in der Lage sein, die Tiefe und Textur analoger Objekte in drei Dimensionen mit Ihren Augen zu entschlüsseln, um die Plastizität sensorischer Neuronen in Ihrem Gehirn zu fördern."
  - question: "Sollten wir nur statische und langweilige Objekte beobachten?"
    answer: "Das genaue Analysieren der Spur des Schwanzzitterns einer Hauskatze, der Bewegung der Flossen eines Fisches in einem Aquarium usw. ist ebenfalls eine sehr gute Übung, die den selektiven Aufmerksamkeitskreislauf des Gehirns scharf aktiviert."
---
...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      Dieser Inhalt basiert auf <strong>Jane Goodall, *In the Shadow of Man* (1971) & Cognitive Neuroscientific Studies</strong>.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <details class="group border-b border-slate-200/60 dark:border-slate-800/60 pb-4 mb-4 cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none">
      <span>Kann ich ein Smartphone-Foto von etwas machen, das ich mit meinen Augen beobachte, und es analysieren?</span>
  ...
  <details class="group cursor-pointer">
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none">
      <span>Sollten wir nur statische und langweilige Objekte beobachten?</span>
      <span class="transition-transform group-open:rotate-180 text-xs text-slate-400">▼</span>
    </summary>
    <p class="mt-3 text-sm text-slate-650 dark:text-slate-300 leading-relaxed pl-1">
