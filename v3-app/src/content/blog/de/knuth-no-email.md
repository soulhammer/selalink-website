...
steps:
  - name: "Festlegung von Offline-Konzentrationsblöcken"
    text: "Planen Sie täglich mindestens 2 aufeinanderfolgende Stunden als Offline-Zeit ein. Schließen Sie Kommunikationstools und schalten Sie Benachrichtigungen komplett stumm."
  - name: "Stapelverarbeitung und Kommunikationsfenster"
    text: "Bearbeiten Sie eingehende E-Mails und Nachrichten einmal oder zweimal täglich in festgelegten Stapeln und vermeiden Sie Antworten in Echtzeit."
  - name: "Fokussierung auf ununterbrochene konzentrierte Arbeit"
    text: "Tauchen Sie während der Offline-Phasen in komplexe Projekte oder Schreibarbeiten ein und nutzen Sie die Abwesenheit von Ablenkungen, um in den Flow-Zustand zu gelangen."
faqs:
...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      Dieser Inhalt basiert auf <strong>Donald Knuths offizielle Erklärung „Knuth: Email“ und Forschung zur kognitiven Belastungstheorie über die Kosten von Kontextwechseln</strong>.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Festlegung von Offline-Konzentrationsblöcken</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Stapelverarbeitung und Kommunikationsfenster</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Fokussierung auf ununterbrochene konzentrierte Arbeit</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none" role="button" aria-expanded="true">
      <span>Wie informiere ich Kollegen über meinen Offline-Zeitplan, um Missverständnisse zu vermeiden?</span>
