...
steps:
  - name: "Stille Meditation direkt nach dem Aufwachen"
    text: "Schalten Sie nach dem Aufwachen nicht das Smartphone ein, sondern setzen Sie sich bequem hin. Schließen Sie die Augen und konzentrieren Sie sich etwa 10 Minuten lang auf Ihren Atem, um das Gehirn sanft aufzuwecken."
  - name: "Repetitive Aktivität zur Stimulierung der Taktilität vorbereiten"
    text: "Legen Sie analoge Utensilien bereit, die Ihre Fingersensoren stimulieren, wie z. B. ein Strickzeug, ein Notizbuch und einen Stift oder eine Teetasse und Teeblätter."
  - name: "10-minütiges taktiles Eintauchen in den einfachen Rhythmus"
    text: "Führen Sie die Aktivität 10 Minuten lang in gleichmäßigem Tempo aus. Konzentrieren Sie sich auf die Textur der Gegenstände und die rhythmischen Bewegungen, um den Geist frei zu machen."
faqs:
...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      Dieser Inhalt basiert auf <strong>Mahatma Gandhis Autobiografie 'My Experiments with Truth' & Fachzeitschrift American Journal of Health Promotion</strong>.
    </p>
  </div>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Stille Meditation direkt nach dem Aufwachen</h4>
  </div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">Repetitive Aktivität zur Stimulierung der Taktilität vorbereiten</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  <div class="flex items-center gap-3 mb-4">
    ...
    <h4 class="text-xl font-extrabold text-slate-900 dark:text-white m-0">10-minütiges taktiles Eintauchen in den einfachen Rhythmus</h4>
  </div>
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <details class="group cursor-pointer" open>
    <summary class="flex justify-between items-center font-bold text-slate-900 dark:text-white list-none">
      <span>Welche modernen taktilen Aktivitäten können das Spinnen ersetzen?</span>
