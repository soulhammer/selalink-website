...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      Dieser Inhalt basiert auf Thomas Edisons persönlichen Aufzeichnungen <strong>&lt;The Diary and Sundry Observations of Thomas Alva Edison&gt;</strong> sowie auf einer Studie des Pariser Hirninstituts (Paris Brain Institute) aus dem Jahr 2021 in der Fachzeitschrift 'Science Advances' über die Steigerung der kreativen Problemlösung im hypnagogischen Zustand.
    </p>
  </div>
</div>
...
## 2. Edisons Schlüssel-Nickerchen-Routine in 3 Schritten für den Alltag

Wir schlagen eine moderne 10-Minuten-Version von Edisons Nickerchen-Methode vor, um das Gehirn bei kreativen Blockaden sofort zu aktivieren.
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Nehmen Sie einen Schlüsselbund oder eine Edelstahl-Trinkflasche in die Hand, die gut zu greifen ist und beim Herabfallen ein lautes Geräusch macht. Stellen Sie ein Metalltablett auf den Boden direkt unter Ihre Hand.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Lehnen Sie sich im Sessel zurück, schließen Sie die Augen und entspannen Sie sich. Denken Sie ganz unverbindlich an das Problem, das Sie lösen möchten, und lassen Sie sich in den Schlaf gleiten.
  </p>
</div>
...
<div class="my-8 p-6 md:p-8 rounded-[2rem] border border-slate-200/80 bg-white/50 dark:border-white/5 dark:bg-slate-900/30 shadow-sm backdrop-blur-md">
  ...
  <p class="text-slate-700 dark:text-slate-300 leading-relaxed text-sm md:text-base m-0">
    Sobald das Objekt herunterfällt und Sie durch das Geräusch geweckt werden, zögern Sie nicht. Schreiben Sie sofort alle Wörter, Bilder und Gedankensplitter in Ihr Smartphone oder Notizbuch.
  </p>
</div>
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-indigo-500 bg-indigo-500/5 dark:bg-indigo-500/10 flex items-start gap-4">
  ...
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">Das Aufwachen vor dem Tiefschlaf ist der entscheidende Punkt</strong>
