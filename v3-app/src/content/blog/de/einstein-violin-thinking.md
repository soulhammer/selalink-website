...
<div class="my-8 p-6 rounded-[2rem] border border-indigo-500/10 bg-indigo-500/5 dark:border-indigo-500/20 dark:bg-indigo-900/10 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-xs text-indigo-700/80 dark:text-indigo-400/80 m-0 mt-1.5 leading-relaxed">
      Dieser Inhalt basiert auf der Biografie <strong>&lt;Einstein: A Life&gt;</strong> sowie kognitionswissenschaftlichen Forschungen (Frontiers in Psychology) über die positiven Auswirkungen des Musizierens auf die kreative kognitive Verarbeitungsfähigkeit und die neuronale Konnektivität.
    </p>
  </div>
</div>
...
## 2. Einsteins 3-Schritte-Reset-Routine für moderne Menschen

Wenn Sie in einer Sackgasse stecken, schlagen wir eine moderne Routine vor, um Ihr Gehirn zurückzusetzen und wie Einstein neue Wege zu finden.
...
<div class="my-6 p-5 rounded-2xl border-l-4 border-indigo-500 bg-indigo-500/5 dark:bg-indigo-500/10 flex items-start gap-4">
  ...
  <div>
    <strong class="text-slate-950 dark:text-white font-extrabold block mb-1">Man muss loslassen können, um neue Ideen zu sehen</strong>
